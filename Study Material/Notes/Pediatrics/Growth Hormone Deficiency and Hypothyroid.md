...
```mermaid
flowchart TD
    A["Radionuclide study (thyroid scan): Iodine-123 > technetium-99.<br>Thyroid scan:"]
    A -->|No uptake| B["USG thyroid"]
    B -->|No gland| C["Thyroid agenesis"]
    B -->|Gland normal| D["Check for TSH receptor antibodies"]
    D -->|+ve:| E["maternal antibodies."]
    D -->|-ve:| F["Iodine trapping / TSH receptor defect."]
    A -->|Ectopic uptake| G["Ectopic thyroid"]
    A -->|Increased uptake| H["Dyshormonogenesis/Iodine deficiency."]
```
