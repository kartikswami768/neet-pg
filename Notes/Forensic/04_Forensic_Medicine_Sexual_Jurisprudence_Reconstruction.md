...
>
> **Scope:** This file reconstructs the educational content actually present in the uploaded PDF. The PDF covers: **Impotence, Virginity, Delivery and Abortion (pp. 1–12); Infant Death and Child Abuse (pp. 13–19); Sexual Offences (pp. 20–27).** It does **not** contain a general forensic toxicology chapter, so no unrelated toxicology material has been invented or added.
>
...
3. [[#3 Assisted Reproduction and Surrogacy]]
4. [[#4 Virginity and Hymen]]
5. [[#5 Pregnancy Pseudocyesis and Twin Pregnancy]]
6. [[#6 Delivery and Related Medicolegal Concepts]]
7. [[#7. Abortion and Medical Termination of Pregnancy]]
8. [[#8. Infant Death and Definitions Around Birth]]
9. [[#9. Intrauterine Death and Maceration]]
10. [[#10. Evidence of Live Birth and Historical Live-Birth Tests]]
11. [[#11. Child Abuse]]
12. [[#12. Munchausen Syndrome by Proxy / Fabricated or Induced Illness]]
13. [[#13. Sudden Infant Death Syndrome]]
14. [[#14. Sexual Offences]]
15. [[#15. Rape — Source Framework and Current Legal Position]]
16. [[#16. Medicolegal Examination in Sexual Assault]]
17. [[#16 Adultery and Incest]]
18. [[#17 Unnatural Sexual Offences — Historical Terminology]]
19. [[#18 Paraphilias and Historical Forensic Terminology]]
20. [[#19 Current Indian Legal Crosswalk]]
21. [[#20 High-Yield Examination Tables]]
22. [[#21 Important Corrections and Outdated Concepts]]
23. [[#22 Source Map and Audit]]
...
- Offence, including rape / bestiality in the source list.
- Renunciation / conversion of religion.
...
│   └── Other semen-introduction techniques
...
- **Incest:** remote genetic risk from donor-recipient relationships within a population.
- **Litigation:** if a child is born with a defect, the recipient couple may initiate a case against the doctor.
...
- Age **25–35 years**.
- Surrogacy only once in a lifetime.
...
|---|---|
| Posterolateral, approximately 4–7 o'clock | Penile penetration |
| Anterior | Digital or foreign-body insertion |
...
- **W** → widow
- **I** → insane / mental illness (source terminology)
- **F** → fetal anomaly
- **R** → rape
...
- **Gastrointestinal irritants:** castor, calotropis.
...
- Cervical dilatation using hygroscopic material in the historical source.
...
- **BNS §91:** act done with intent to prevent a child from being born alive or to cause it to die after birth.
- **BNS §92:** causing death of a quick unborn child by an act amounting to culpable homicide.

> **Exam rule:** If an old question explicitly asks for **IPC**, give the historical IPC section. If the question asks for **current law**, use BNS terminology/sections.
...
The timeline on the source page visually distinguishes:

```text
≈28 weeks ─── delivery ─── 24 hours ─── 28 days ─── 1 year
             ↑               ↑              ↑
          neonaticide     neonatal      infancy
                         terminology
```
...
- **Filicide:** killing of a child by a parent.
- **Infanticide:** killing of an infant/child, with legal treatment dependent on the applicable offence.
- **Neonaticide:** killing during the neonatal period.

## 8.2 Important IPC sections in the source
...
The legal registration framework distinguishes **live birth**, **fetal death**, and **stillbirth**. The commonly used 28-week stillbirth threshold appears in the relevant registration rules, but **stillbirth registration terminology should not be conflated with a universal biological “viability” threshold**.
...
```text
Intrauterine death
├── Intact amniotic sac + no air
│   └── Aseptic autolysis / maceration
├── Reduced amniotic fluid
│   └── Ischaemia + dehydration → mummification
└── Ruptured membranes
    └── Bacteria from outside → putrefaction
```

### Excess amniotic fluid

The source associates excess amniotic fluid with **autolysis / maceration**.

### Deficient amniotic fluid

The source associates deficient fluid with:
...
The PDF says Indian law does not define a viability period and gives **28 weeks** as the clinical teaching value.
...
- Slipping skin with copper-brown discoloration.
- Skin blebs / blisters at about **24 hours** in the source.
- Soft, flaccid baby; when placed on a flat surface, loss of normal curvature may occur by about **2 days** in the source.
...
Step 1: Heart–lung block → flotation test
        ↓
Step 2: Lungs ligated at hilum → flotation test
        ↓
Step 3: Individual pieces of lung → flotation test
        ↓
Step 4: Squeeze lung pieces → repeat flotation
        ↓
...
These are preserved as **source examination points**; none is independently pathognomonic for live birth.
...
4. Child improves in the parent's absence.
5. Previous history of multiple hospitalizations.

> **Current terminology:** Contemporary child-protection literature commonly uses **fabricated or induced illness (FII)** in contexts where a caregiver fabricates or induces symptoms/signs of illness.
...
- Increased risk for a twin if the co-twin died similarly.
- More common in the early morning.
- Maternal alcohol and smoking are listed as risk factors.
- Prematurity is associated with increased risk.
...
This is why scene examination, complete autopsy, history review and careful death investigation are crucial.
...
- **BNS §66:** causing death or persistent vegetative state in specified rape cases.
- **BNS §67:** sexual intercourse by husband with wife during separation.
...
- **BNSS §52:** examination of a person accused of rape by a medical practitioner.
- **BNSS §184:** medical examination of a victim of rape.
- **BNSS §366:** in-camera trial for specified sexual-offence proceedings.
...
| Circumstance | Source rule |
|---|---|
| Examination at police request | Old CrPC §53A; reasonable force may be used as permitted by law |
| Examination at accused's own request | Old CrPC §54A cited by source |
| Consent | Source says consent is not mandatory for the legally authorized examination |
| Refusal | Source notes informed refusal should be recorded |
...
- examination should be respectful and privacy-protective;
...
1. Take a swab from the penis.
2. Expose it to iodine vapour.
3. Brown colour indicates a positive test in the source's framework.
4. The source interprets this as vaginal epithelial-cell material.
5. The source says it may remain positive for approximately 4 days if not washed.
...
- spermatozoa → up to approximately 3 days;
...
Current guidance specifically rejects:

- two-finger / per-vaginal “virginity” testing;
- conclusions based on hymenal appearance as proof of intercourse;
- statements about vaginal introitus “laxity” or “tightness” as evidence of sexual history;
- statements about anal opening size/elasticity proving previous anal intercourse;
- statements that the absence of injury proves absence of sexual assault.

See also [[#4 Virginity and Hymen]].
...
> Sexual gratification achieved by methods other than sexual intercourse.
...
Historical synonym in the source:
...
The source associates this with old IPC provisions relating to public nuisance/sexual harassment.
...
The PDF attributes both to old **IPC §297**.
...
## 20.1 Major sexual-offence provisions

| Historical source reference | Current framework / note |
|---|---|
| IPC §375 — rape | **BNS §63 — rape** |
| IPC §376 — punishment for rape | **BNS §64** and related aggravated provisions |
| IPC §376A | Current aggravated framework includes **BNS §66** for specified death/persistent-vegetative-state situations |
| IPC §376B | **BNS §67** — sexual intercourse by husband with wife during separation |
| IPC §376C | **BNS §68** — sexual intercourse by person in authority |
| IPC §376D | **BNS §70** — gang rape |
| IPC §376E | **BNS §71** — repeat offenders |
| IPC §228A | **BNS §72** — disclosure of identity of certain sexual-offence victims |
| CrPC §327(2) | **BNSS §366** — in-camera proceedings in specified cases |
| Evidence Act §114A | **BSA §120** — presumption relating to absence of consent in specified rape prosecutions |

## 20.2 Medical examination provisions

| Historical source reference | Current provision |
|---|---|
| CrPC §53A | **BNSS §52** — examination of person accused of rape by medical practitioner |
| CrPC §164A | **BNSS §184** — medical examination of victim of rape |
| CrPC §357C | Corresponding duties of treatment/hospital care are now situated in the BNSS/current health-law framework |

## 20.3 Miscarriage / criminal abortion provisions

| Historical IPC | Current BNS subject matter |
|---|---|
| §312 | **BNS §88** — causing miscarriage |
| §313 | **BNS §89** — miscarriage without woman's consent |
| §314 | **BNS §90** — death caused by act done with intent to cause miscarriage |
| §315 | **BNS §91** — act intended to prevent child being born alive / causing death after birth |
| §316 | **BNS §92** — causing death of quick unborn child by act amounting to culpable homicide |
| §317 | **BNS §93** — abandonment of child under the statutory conditions |
| §318 | **BNS §94** — concealment of birth by secret disposal of dead body |

## 20.4 Adultery

| Historical | Current position |
|---|---|
| IPC §497 | Struck down as unconstitutional by Supreme Court in **Joseph Shine v. Union of India (2018)**; adultery is not a criminal offence merely as adultery |

It may still have matrimonial/civil consequences.

## 20.5 Same-sex conduct and historical §377

The old IPC §377 framework was modified by the Supreme Court in **Navtej Singh Johar v. Union of India (2018)** so that consensual sexual activity between adults of the same sex is not criminalized under that provision.

The BNS does not reproduce the old IPC §377 as a general adult same-sex offence. Children, non-consensual conduct, sexual assault and acts involving animals require separate analysis under the laws currently applicable to those facts.

## 20.6 Obscenity and voyeurism

- **BNS §75:** sexual harassment.
- **BNS §77:** voyeurism.
- **BNS §296:** obscene acts and songs.

The exact section applicable to a real case depends on the conduct and circumstances.

## 20.7 Corpse-related conduct

The PDF's old reference to **IPC §297** should not be memorized as a current section number. The BNS contains **§301** concerning indignity to a human corpse / human dead body.

## 20.8 Child sexual offences

The **Protection of Children from Sexual Offences Act, 2012 (POCSO)** remains a key statute for offences involving persons below 18 years.

> **Exam pearl:** A purported consent by a child below 18 does not convert a POCSO sexual act into a consensual adult sexual relationship.

---

# 21. High-Yield Forensic and Examination Tables

## 21.1 Historical virginity examination — what the PDF teaches versus current practice

| Source teaching | Current forensic position |
|---|---|
| Intact hymen listed as a “sign of virginity” | Hymen cannot prove virginity or prior intercourse |
| Fimbriate notches can mimic tears | Correct; normal hymenal variants can resemble injuries |
| Torn hymen discussed by site/shape | Injury should be documented objectively; site alone cannot establish intercourse mechanism |
| Glaister-Keen rod described | Historical; not a valid virginity test |
| Vaginal rugosity used as source “sign” | Not a reliable indicator of sexual history |
| “False virgin” concept in thick/elastic hymen | Intact hymen does not exclude prior intercourse |

## 21.2 Pregnancy signs

| Category | Examples from source | Interpretation |
|---|---|---|
| Presumptive | Amenorrhoea, nausea, breast changes, quickening | Suggestive only |
| Probable | Goodell, Hegar, Braxton-Hicks, ballottement, hCG | Stronger but not all absolute |
| Positive | Fetal cardiac activity, fetal parts/movements, ultrasound | Objective confirmation according to gestational age |

## 21.3 Maceration versus putrefaction — source mechanism

| Situation | Mechanism |
|---|---|
| Intact sac + no air + excess liquor | Aseptic autolysis / maceration |
| Deficient liquor | Ischaemia + dehydration → mummification |
| Ruptured membranes | Bacterial entry → putrefaction |

## 21.4 Hydrostatic test

| Stage | What to do |
|---|---|
| 1 | Heart–lung block flotation |
| 2 | Ligate hilum and repeat |
| 3 | Test individual lung pieces |
| 4 | Compress/squeeze pieces and repeat |
| Control | Liver control for decomposition gas |
...
## 21.5 Child abuse: high-yield red flags from the source

| Red flag | Why it matters |
|---|---|
| History inconsistent with injuries | Raises concern for non-accidental trauma |
| Delay in presentation | Can be important in context |
| Multiple injuries of different ages | Suggests repeated trauma when supported by imaging/exam |
| Posterior rib fractures | Important in infant abuse assessment |
| Metaphyseal corner/bucket-handle lesions | Classic high-risk skeletal injury pattern |
| Oral frenular injuries | Important injury pattern in context |
| Cigarette burns / sharply demarcated scalds | Patterned injuries may suggest inflicted trauma |
| Intracranial + retinal injury | Requires expert evaluation for AHT and differentials |

## 21.6 SIDS versus infanticide — forensic principle

| SIDS | Infanticide / homicide |
|---|---|
| Unexplained after complete investigation | A homicide cause/mechanism can be established |
| Usually nonspecific autopsy findings | Injuries or other evidence may demonstrate inflicted death |
| Scene investigation essential | Scene, history, injury interpretation and forensic evidence essential |
| Autopsy alone insufficient | Multidisciplinary interpretation required |

## 21.7 Historical sexual-offence terminology

| Source term | Modern approach |
|---|---|
| Natural / unnatural offence | Use the actual current statutory offence |
| Sodomy | Historical descriptive term; describe exact act without assuming a legal offence label |
| Lesbianism | Same-sex sexual activity is not itself a mental disorder or general criminal offence |
| Sexual perversion | Obsolete; use current clinical terminology only when a diagnosis is actually established |
| Transsexualism | Obsolete and inappropriate as a label for gender identity |
| Uranism | Obsolete historical term for male homosexuality |
| Habitual passive victim | Not a scientifically reliable forensic diagnosis |
| Virginity testing | Scientifically invalid / not recommended |

---

# 22. Important Corrections and Outdated Concepts

This section makes significant changes **explicit** instead of silently altering the source.

## 22.1 Criminal law changed after the PDF

> **Source PDF:** Uses IPC, CrPC and the Indian Evidence Act section numbers.
>
> **Current verification:** From 1 July 2024, the principal criminal-law framework is the BNS, BNSS and BSA. Old section numbers remain useful for historical exam questions but are not current-law references.

## 22.2 Virginity and hymenal findings

> **Source PDF:** Lists an intact hymen, vaginal rugosity and related findings as “signs of virginity.”
>
> **Current verification:** These findings cannot establish virginity or prior intercourse. WHO states that virginity testing has no scientific validity and that no examination can prove whether a woman has had vaginal intercourse.

## 22.3 Sexual-assault examination

> **Source PDF:** Describes Lugol iodine and old semen/sperm time cut-offs.
>
> **Current verification:** These are historical forensic teaching points. Current sexual-assault care is based on informed consent, appropriate examination, validated evidence collection and DNA/biological methods where indicated. Evidence yield is time-dependent but not determined by a rigid single cut-off.

## 22.4 MTP gestational limits

> **Source PDF:** Presents a simplified ≤20 / 20–24 / >24-week framework and a list of categories.
>
> **Current verification:** This framework remains broadly aligned with the MTP Act/Rules but must be read with the current statutory categories, Medical Board provisions and emergency exception. The source shorthand “all cases” should not be interpreted as meaning that statutory conditions are irrelevant.

## 22.5 Surrogacy

> **Source PDF:** Lists the surrogate mother's own egg as a possible gamete source.
>
> **Current verification:** Under current regulated Indian surrogacy rules, a surrogate mother does not contribute her own oocyte. The 2024 amendment allows a donor gamete in specified medically certified circumstances, while requiring at least one gamete from the intending couple.

## 22.6 SIDS definition

> **Source PDF:** Gives an age span extending to 2 years and says petechiae are the only consistent autopsy finding.
>
> **Current verification:** SIDS is a cause assigned to unexplained infant death after complete investigation; petechiae are nonspecific and not diagnostic. The historical age description in the source should not be used as a current definition.

## 22.7 Battered baby / shaken baby terminology

> **Source PDF:** Uses “battered baby syndrome,” “Caffey syndrome,” “shaken baby syndrome,” and a triad.
>
> **Current verification:** Modern pediatric guidance prefers **child physical abuse** and **abusive head trauma (AHT)** as clinical terminology. AHT is a complex diagnosis and is not reducible to a single mechanism or a single fixed triad.

## 22.8 Outdated psychiatric/sexual terminology

The following source terms are historical and should not be used as current diagnoses simply because they appear in the PDF:
...
- sexual perversion;
- transsexualism;
- uranium/uranism terminology for homosexuality;
- habitual passive victim.

---

# 23. Practical Medico-Legal Examination Algorithms

## 23.1 Sexual-assault medical examination — current-practice workflow

```text
Survivor presents
      ↓
Immediate stabilization / emergency treatment
      ↓
Explain examination, treatment and evidence options
      ↓
Obtain informed consent for each relevant component
      ↓
History + objective examination + injury documentation
      ↓
Collect forensic evidence according to nature of assault, time elapsed,
body sites involved, bathing/washing and other case factors
      ↓
Label + package + seal + document chain of custody
      ↓
Pregnancy prevention / pregnancy testing as clinically indicated
      ↓
STI/HIV/hepatitis prophylaxis and other medical care as indicated
      ↓
Medicolegal report
      ↓
Appropriate police / legal communication under current law
```

## 23.2 MTP decision framework

```text
Pregnant woman presents for MTP
        ↓
Confirm pregnancy + gestational age + clinical circumstances
        ↓
Assess whether statutory grounds are met
        ↓
┌──────────────────────────────────────────────┐
│ Up to 20 weeks                               │
│ → 1 RMP opinion, subject to MTP Act/Rules    │
└──────────────────────────────────────────────┘
        ↓
┌──────────────────────────────────────────────┐
│ 20–24 weeks                                  │
│ → 2 RMP opinions for prescribed categories   │
└──────────────────────────────────────────────┘
        ↓
┌──────────────────────────────────────────────┐
│ >24 weeks                                    │
│ → specified substantial fetal abnormality    │
│   + Medical Board pathway                    │
└──────────────────────────────────────────────┘
        ↓
Emergency to save pregnant woman's life
→ special statutory emergency provision
```

## 23.3 Hydrostatic test — historical forensic flow
...
Float
      ↓
If appropriate, ligate hilum
      ↓
Float individual lung pieces
      ↓
Squeeze pieces and repeat
      ↓
Check decomposition control (liver)
      ↓
Interpret with complete autopsy + scene + history
```

---

# 24. Viva / NEET-PG / INI-CET Pearls

## Impotence and marriage

- **Impotence:** inability to achieve/maintain penile erection in the source definition.
- **Sterility:** inability to beget children.
- **Impotence *quod hanc*:** impotence toward a particular woman.
- **Consummation:** the source emphasizes actual penetration; one penetration is enough.

## Hymen

- Fimbriate hymen → normal notches can mimic tears.
- Posterolateral tears are a historical exam association with penile penetration.
- Anterior injuries may be associated in the source with digital/foreign-body insertion.
- **No hymenal examination can prove virginity.**

## Pregnancy

- Presumptive → amenorrhoea, nausea, breast changes, quickening.
- Probable → Goodell, Hegar, Braxton-Hicks, ballottement, hCG.
- Positive/objective → fetal cardiac activity and imaging/appropriate objective fetal findings.
- Pseudocyesis → pregnancy symptoms without an actual intrauterine pregnancy.
- Superfecundation → same ovulatory cycle; may be heteropaternal.
- Superfetation → different ovulatory cycles; extremely rare in humans.

## Delivery

- Lochia is a sign of recent delivery, but timing is variable.
- Posthumous child → born after alleged father's death.
- Atavism → ancestral characteristic.

## Abortion

- Source historical IPC §312 → current BNS §88 subject matter.
- Source historical IPC §313 → current BNS §89 subject matter.
- Source historical IPC §314 → current BNS §90 subject matter.
- MTP: ≤20 weeks / 20–24 weeks / >24-week Medical Board pathway in current framework.
- Husband's consent is **not required** for a competent adult woman undergoing MTP under the statutory framework.
- Confidentiality is legally protected.

## Infant death

- Maceration → aseptic autolysis in retained sac / sterile environment in the source framework.
- Spalding sign → overlapping cranial bones.
- Robert's sign → intravascular gas in fetal great vessels.
- Hydrostatic lung test → historical; false positive with decomposition/artificial respiration, false negative with atelectasis/feeble respiration.

## Child abuse

- Inconsistent history + delay + multiple injuries of different ages → important warning pattern.
- Posterior rib and metaphyseal corner/bucket-handle injuries are important infant abuse patterns.
- Current head-injury terminology → **abusive head trauma**.

## SIDS

- SIDS is a diagnosis of exclusion after thorough investigation.
- Autopsy can be nonspecific.
- Petechiae are not pathognomonic.

## Sexual assault

- **Consent is mandatory for the survivor's medical examination.**
- Treatment must not be withheld because forensic evidence collection is declined.
- No two-finger virginity test.
- No valid forensic opinion that “intact hymen = virgin.”
- Evidence detection is time-dependent, not a rigid single cut-off.
...
- CrPC → BNSS.
- Evidence Act → BSA.
- Adultery is not a criminal offence under IPC §497 following *Joseph Shine*.
- Consensual same-sex adult sexual activity is not criminalized under the old §377 framework following *Navtej Singh Johar*.
- POCSO applies to sexual offences involving children below 18 years.
...
- **India Code:** Medical Termination of Pregnancy Act, 1971, as amended.
- **MTP Rules**, including 2021 amendments.
- **Surrogacy (Regulation) Act, 2021** and current Surrogacy Rules/amendments.
- **Protection of Children from Sexual Offences Act, 2012.**
- Supreme Court of India: **Joseph Shine v. Union of India** (2018).
- Supreme Court of India: **Navtej Singh Johar v. Union of India** (2018).

## Medical / forensic guidance

- WHO guidance on management of rape survivors and rejection of virginity testing.
- Government of India / MoHFW medico-legal care guidelines for survivors of sexual violence.
- American Academy of Pediatrics guidance on **abusive head trauma**.
- American Academy of Pediatrics guidance on **SIDS / sudden unexpected infant death**.
