...
|---|---|
| **Blunt force** | Abrasion, contusion, laceration, fracture |
| **Sharp force** | Incised wound, chop wound |
...
- In a simple abrasion, the **epidermis is mainly involved**.
- The PDF states that uncomplicated abrasions usually have **no significant bleeding or scar formation**.
- The PDF notes that abrasions are generally considered **simple hurt**, with **corneal abrasion** singled out because visual impairment can make it legally significant as grievous hurt under the teaching framework used in the notes.
...
|---|---|---|
| Site | Anywhere | Often pressure/contact areas depending on handling |
| Colour | Typically reddish | May be pale/yellowish depending on postmortem change |
| Vital reaction | Present | Absent |
| Enzymatic/vital-zone changes | Present | Absent |
...
Extravasation of blood
   ↓
Blood diffuses into surrounding tissue
   ↓
Contusion / bruise
```
...
- **Scalp:** contusion may be **better felt than seen**.
- **Loose areolar tissue:** bruising is readily apparent.
- **Eyelid/scrotum:** relatively little force can produce marked bruising.
- **Face:** increased vascularity contributes to prominent bruising.
- **Firm/thick fibrous tissue:** bruising may be less obvious; the source specifically mentions palms and soles.
...
- Traditionally associated with **fracture of the middle cranial fossa/skull base**.
- The source places onset around **12–24 hours** after injury.

**Cullen sign / Grey Turner sign**
- The source associates these with an **acute abdominal process**.
- These are clinically important signs of underlying hemorrhage/retroperitoneal or intra-abdominal bleeding, not simple indicators of direct local trauma.
...
|---|---|
| Initial | Red — oxyhaemoglobin |
| Early | Blue — deoxyhaemoglobin |
| Later | Bluish-black/brown — hemosiderin |
| Later | Green — biliverdin/haematoidin |
| Later | Yellow — bilirubin |
| Resolution | Normal skin |

The annotated figure in the PDF gives approximately:

- Red → initially
- Blue → few hours to ~3 days
- Bluish-black/brown → around day 4
- Green → ~5–6 days
- Yellow → ~7–12 days
...
| Margins | Usually relatively well-defined | May be defined |
| Extravasation into tissue | **Absent** | **Present** |
| Slanching/blanching | Classically may partially blanch early | Persists |
...
A split laceration may look like an incised wound to the naked eye.
...
```text
Heavy blunt force at an angle
        ↓
Pressure + pulling force
        ↓
...
| Margins | Irregular | Clean and regular |
| Edge contusion | Often present | Usually absent |
| Tissue bridges | **Present** | **Absent** |
| Tissue crushing | Present | Minimal/absent |
| Haemorrhage | Usually less than incised wound | Often profuse |
...
- Superficial
- Relatively parallel
- On accessible parts of the body
...
- In a complete penetrating wound, the depth can approximate blade length under suitable circumstances.
...
A **double-edged blade** can produce a more characteristic spindle/elliptical wound.

The source also illustrates characteristic wound shapes from:
- Single-edged blade
- Screwdriver
- Dinner fork
- Ice pick
...
Significance:
- Indicates possible **complete penetration**
- May provide a clue about the weapon
...
- Wound **perpendicular** to cleavage lines → **more gaping**
- Wound **parallel** to cleavage lines → **less gaping**
...
Reason:
- Probing may disrupt a clot.
- It may provoke/precipitate further bleeding.
- It can alter the wound track.
...
- The source presents the mechanism:
...
- **Usually homicidal**
- May be accidental
- **Not typically suicidal** in the classical teaching framework
...
The source notes:
- Usually a **personal motive**
- Often **incised wounds**
- May be superficial
...
| Self-suffered | May occur anywhere on the body |
...
- Considered a variant of depressed injury.
...
**Type II**
- Fracture line starts posteriorly and passes through the sella turcica toward the anterior region.
...
The source emphasizes:
- Brain is commonly involved.
- Other organs can also show coup/contrecoup-type mechanisms.
...
- Mechanical/vacuum effect on the opposite side
- Predisposition to injury on the opposite surface
...
- **A**ged/alcoholic
- **B**ridging veins
- **C**hild abuse / crescentic opacity
...
- If blood **persists** → interpreted as SAH in the source.
...
| Source | Middle meningeal artery | Bridging veins | Arterial circulation/Circle of Willis |
| Classic mechanism | Temporoparietal impact | Acceleration–deceleration | Trauma or spontaneous aneurysm/AVM |
| Shape on CT | Lentiform/biconvex | Crescentic | Diffuse sulcal/basal cisternal blood |
| Crosses sutures | Usually no | Yes | Not applicable as an extra-axial collection |
...
| Moderate | 32–28°C | Progressive CNS depression |
...
Severe cold
   ↓
Loss/failure of vasoconstriction
   ↓
Peripheral vasodilation
   ↓
Victim feels unexpectedly warm
   ↓
Undressing
```
...
- Rewarming target around **37–40°C** in the notes
- Cardiopulmonary bypass for selected severe cases
...
Sweating
   ↓
Electrolyte (especially Na+) loss
   ↓
Muscle cramps
```
#### Treatment in source
...
Increased sweating
 ↓
Circulatory redistribution / reduced effective circulation
 ↓
...
- Traditional distinction:
  - Classical → less sweating
  - Exertional → diaphoresis may be present
...
- Lower temperature can still cause burns if exposure is prolonged.

The PDF includes a historical teaching statement that a fire exposure around **44°C for 8–10 hours** can produce a burn.
...
- Boiling/coagulation-related changes
- Rupture of emissary veins/dural venous structures

Features in the source:
- Extradural location
- Often **bilateral/diffuse**
- **Honeycomb** appearance
- Brown/chocolate-coloured clot
...
The source describes:
- **Skull fractures** due to steam pressure/drying
- **Long-bone fractures** due to drying and muscle contraction
...
- **R** — Redness / erythema
- **E** — Elevated enzymes in the positive/vital reaction zone
...
- Closed eyelids → less soot reaching the periocular skin
...
2. **Splash/spill scald**
   - Uneven distribution according to liquid flow.
...
Hammer moves
   ↓
Firing pin moves forward
   ↓
Primer is struck
   ↓
Propellant ignites
   ↓
Projectile is propelled down barrel
   ↓
Projectile exits muzzle
```
...
| Projectile | Usually single bullet | Usually multiple pellets/shots |
| Effect of barrel | Imparts spin | Does not impart rifling spin |
| Typical range | Longer | Shorter |
| Dispersion | Low/controlled | Pellets disperse |
...
- Acts as a piston
- Transmits propellant energy to the shot
- Provides obturation
- May contain lubricant/filler material
- The source states the wad may travel several metres

Types/materials mentioned:
- Wood
- Cork
- Plastic
...
Increasing number → **finer powder**.
...
|---|---|
| Soft shot | Lead only |
| Hard/chilled shot | Lead + steel |
| Steel shot | Steel only |
| Dust shot | Very fine/many small particles |
| Bird shot | Very small pellets; source gives ~200 pellets |
| Buck shot | Larger pellets; source gives ~20 pellets |
...
```text
Crime-scene bullet recovered
        ↓
Suspected firearm recovered
        ↓
Test firing (under controlled forensic conditions)
        ↓
Comparison of markings
        ↓
Assess whether markings are consistent
```
...
They are related to the rifling pattern shared by firearms of the same model/make.
...
- Proximity to a discharge
- Contact/secondary transfer

Similarly, absence of GSR does not by itself exclude firing.

See current standards:
- NIST/OSAC **ANSI/ASTM E1588-25** — GSR analysis by SEM/EDS.
...
The source describes:
- Old unused cartridge/gun condition
- First trigger pull → no projectile
...
- Reduced/absent flame
- Reduced smoke/powder effects
- Loss of spin
- Absent abrasion collar in some cases
- Possible tumbling and atypical wound
...
- ~16 mA for loss of voluntary release in an average adult
- ~20 mA for respiratory muscle paralysis
- ~100 mA for ventricular fibrillation threshold under specified conditions
...
| Conductor | Colour described in PDF |
|---|---|
| Aluminium | Silver |
| Copper | Red-brown |
| Iron | Brown |
...
- Homicidal — e.g. judicial electrocution
- Suicidal
...
- **Direct strike**
- **Side strike**
- Contact with an object/conductor
- Ground-related electrical effects

It also describes a **blast-like pressure effect**:
- Superheated, expanded and displaced air
- “Sledgehammer effect”
...
- Feathering
- Lichtenberg burns
- Keraunographic marks

Features in source:
- Branching/fern-like pattern
...
Other severe consequences may result from:
- Neurological injury
...
- Rag as wick
- Wick ignited before/at the time of use
...
as common fragment-related injuries.

The notes also mention a **“Marshall's triad”** association with abrasion + contusion + laceration on the same side.
...
- Building collapse
- Fire
- Other miscellaneous blast-related mechanisms
...
|---|---|
| **Telefona / telefono** | Repeated slapping over the ears |
| **Falanga / Falaka / Bastinado** | Beating over the soles of the feet |
| **Wet submarine** | Forced immersion of the head under water |
| **Dunking** | Forced immersion of the body under water |
| **Dry submarine** | Plastic-bag asphyxiation |
| **Cattle prod** | Electrical shock to genitalia |
| **Saw horse** | Forced straddling |
| **Hog tying** | Wrists and ankles tied together in prone position |
...
- Document alleged torture/ill-treatment

Documentation should be objective and descriptive.
...
- Type of vehicle
- Vehicle speed
- Point/level of impact
- Whether impact is above/below the centre of gravity
...
| Mechanism | Vehicle passes over victim | Victim is rolled along the road |
| Pattern | Crushing | Circumferential injuries |
...
- Sudden deceleration
- Secondary collision with vehicle interior
- Windshield impact
...
Knee strikes dashboard
       ↓
Femur driven posteriorly
       ↓
PCL/acetabular injury
       ↓
...
- Glass-related lacerations
- **Sparrow-foot** pattern
...
- Sternal fracture
- Rib fractures
- Forearm fractures from bracing
- Patterned bruising
- **Aortic injury**
...
Shearing forces
          ↓
Relatively fixed aortic arch + mobile descending aorta
          ↓
High stress at attachment zone
          ↓
Aortic tear/rupture
```
...
Potential sites:
- **Aortic root**
- Especially **aortic isthmus**

The source also mentions:
- Transverse aortic tears
- “Ladder-rung” tears
...
Sudden deceleration
       ↓
Small bowel moves forward
       ↓
Mesentery is relatively fixed
       ↓
Shearing injury
       ↓
Mesenteric tear / bowel injury
```

The source contrasts:
- Small intestine ≈ 3 m in length in the notes
- Mesentery ≈ 8 inches as a source teaching value
...
- **Thoracic/intra-abdominal injuries**
- **Contralateral head injury**

The PDF describes these as:
1. **Primary impact** → femoral shaft fracture
2. **Secondary impact** → intrathoracic or intra-abdominal injuries
3. **Tertiary impact** → contralateral head injury
...
1. The tumour site was previously normal before injury.
2. The trauma must be **adequate**.
3. There is a temporal interval between trauma and tumour, given in the PDF as approximately **3 weeks to 3 years**.
4. Tumour arises from the **same part**.
5. Tumour has the **same histological type**.
...
| Epidermis | Usually damaged | Intact | Breached | Breached |
| Dermis | Usually little/no deep involvement | Involved | Torn | Cleanly cut |
| Margins | Superficial scraped | N/A | Irregular | Clean/regular |
| Tissue bridges | N/A | N/A | **Present** | **Absent** |
| Edge contusion | N/A | N/A | Common | Usually absent |
| Tissue crushing | May occur in pressure abrasion | No defining feature | **Present** | Absent |
...
| Dominant dimension | Length | Depth |
| Typical surface shape | Linear | Oval/spindle |
| Tissue cutting | Surface-dominant | Deep track |
| Margins | Clean | Usually clean, morphology influenced by blade |
...
| Typical age | Young adult | Elderly/infant risk groups |
| Mechanism | Blow to pterion/temporal region | Acceleration–deceleration |
| CT | Lentiform/biconvex | Crescentic |
| Sutures | Does not cross | Crosses |
| Classic presentation | Lucid interval | More variable |
...
|---|---|---|
| Margin | Inverted | Everted |
| Abrasion collar | Typical | Usually absent |
| Grease collar | May be present | Usually absent |
| Burning | May occur in close range | Usually absent |
| Blackening | May occur in close range | Absent |
| Tattooing | May occur | Absent |
| Size | Usually smaller | Usually larger |
| Skull | Internal beveling | External beveling |
...
Flame ↓
Smoke/blackening ↓
Powder residue/tattooing persists farther
```
...
Single pellet mass
       ↓
Beginning dispersion
       ↓
Satellite holes
       ↓
Independent pellet holes
```
...
- **Ectopic bruise** → blood tracking away from impact.
- **Battle sign** → skull-base/mastoid-region injury clue.
- **Scalp contusion** → may be felt better than seen.
- **Laceration** → blunt force + irregular margins + tissue bridges.
- **Incised wound** → sharp force + clean margins + no tissue bridges.
- **Tailing** → helps infer direction of an incised wound.
- **Bevelling** → oblique entry; interpret in context.
- **Stab wound** → depth generally exceeds surface dimensions.
- **Never blindly probe a stab wound.**
- **Hilt mark** → may indicate complete penetration by a guarded weapon.
- **Defence injury** does not prove homicide and its absence does not exclude homicide.
- **Puppe's rule** → newer fracture line stops at an older fracture.
- **EDH** → middle meningeal artery + lentiform collection + lucid interval.
- **SDH** → bridging veins + crescentic collection.
- **SAH** → thunderclap headache + blood in subarachnoid space; Circle of Willis is classic spontaneous source.
- **Hypothermia** → paradoxical undressing + terminal burrowing.
- **Wischnewsky spots** → classical hypothermia association.
- **Heat stiffening/heat rupture** can mimic traumatic injury.
- **Antemortem burn** → vital reaction and inflammatory features.
- **COHb** can support smoke exposure but must be interpreted with context.
- **Shotgun** → multiple pellets; dispersion increases with distance.
- **Skull gunshot entry** → internal beveling.
- **Skull gunshot exit** → external beveling.
- **GSR is associative, not a standalone identification of the shooter.**
- **Electrocution** → current pathway through the chest is particularly dangerous.
- **Lightning** → Lichtenberg figures are classic but transient.
- **Primary blast injury** → blast wave.
- **Secondary blast injury** → fragments.
- **Tertiary blast injury** → displacement.
- **Quaternary blast injury** → burns/crush/asphyxia and miscellaneous effects.
- **Pedestrian injury sequence** → primary impact → secondary vehicle impact → tertiary ground impact.
- **Bumper fracture** → traditional clue to impact level/direction.
- **Dashboard injury** → patella/PCL/posterior hip.
- **Seat-belt injury** → patterned abdominal/chest bruising + Chance-type spinal injury.
- **Aortic injury** → classically aortic isthmus in high-energy deceleration.
...
Reference:
- Kemp AM et al. Systematic review of bruise-age estimation in children.
...
- Modern practice emphasizes **SEM/EDS** for primer GSR analysis.
- Collection and interpretation must be standardized.
- pGSR can arise from discharge, proximity, or transfer.
- Positive GSR does **not independently prove that a particular person fired the weapon**.
- Negative GSR does **not independently exclude firing**.

Current standards:
- ANSI/ASTM E1588-25 — SEM/EDS analysis of GSR.
...
- Electrical injury is influenced by current, duration, pathway, resistance, frequency and individual factors.
- Published physiological thresholds vary.
- AC is particularly hazardous because it can induce repetitive tetanic muscle contraction and impair release from the source.
...
The PDF's old section number should therefore be retained only for historical/exam-context understanding, not as the current section to quote in practice.
...
2. **National Institute of Standards and Technology (NIST) / OSAC**
   - ANSI/ASTM E1588-25 — Standard Test Method for Gunshot Residue Analysis by SEM/EDS.
   - https://www.nist.gov/standard/2116

3. **NIST / OSAC**
   - ANSI/ASTM E3345-26 — Standard Practice for Opinions on Interpretation of Primer Gunshot Residue Analysis by SEM/EDS.
   - https://www.nist.gov/osac/standards-library/ansiastm-e3345-26

4. **NIST — Firearms and Toolmarks**
   - https://www.nist.gov/firearms-and-toolmarks

5. **NIST — Gunshot Residue overview**
   - https://www.nist.gov/glossary-term/44651

6. **NIST — Gunshot Residue collection/overview**
   - https://www.nist.gov/system/files/documents/2020/08/26/CSI_Guide_07302020_ForPublication.pdf

7. **Kemp AM et al. — Can you age bruises accurately in children? A systematic review**
   - https://pmc.ncbi.nlm.nih.gov/articles/1720275/

8. **Vitality and wound-age estimation in forensic pathology: review and future prospects**
   - https://pmc.ncbi.nlm.nih.gov/articles/PMC7241561/

9. **Review of electrical current conduction through the human body**
   - https://pmc.ncbi.nlm.nih.gov/articles/2763825/

10. **DGHS/MoHFW Hospital Manual — Guidelines for Medicolegal Work**
...
Pressure abrasion         → Crushing of epithelium
Patterned abrasion        → Object pattern
Contusion                 → Extravasated blood, intact epidermis
Ectopic bruise            → Blood tracking away from impact
Laceration                → Blunt force + tissue bridges
Incised wound             → Sharp force + clean margins
Tailing                   → Direction of incised-wound force
Stab wound                → Depth > surface dimensions
Hilt mark                 → Guard impact / possible complete penetration
Puppe's rule              → New skull fracture stops at old fracture
EDH                       → MMA + lentiform + lucid interval
SDH                       → Bridging veins + crescentic
SAH                       → Thunderclap + basal subarachnoid blood
Hypothermia               → Paradoxical undressing + terminal burrowing
Wischnewsky spots         → Hypothermia
Heat rupture              → Pugilistic/boxer's posture
Antemortem burn           → Vital inflammatory reaction
COHb                      → Smoke exposure marker, context dependent
Rifle entry               → Abrasion collar / possible residue
Skull firearm entry       → Internal beveling
Skull firearm exit        → External beveling
Shotgun distant           → Pellet dispersion / separate holes
GSR                       → Associate; not standalone shooter identification
Electrocution             → Current pathway matters
Lightning                 → Lichtenberg figures
Primary blast             → Blast wave
Secondary blast           → Fragments
Tertiary blast            → Displacement
Pedestrian injury         → Primary → secondary → tertiary impact
Dashboard injury          → Patella/PCL/posterior hip
Seatbelt injury           → Bruise + Chance injury
Aortic deceleration       → Aortic isthmus
...
Ancillary investigations
   +
Autopsy/clinical findings
   ↓
Final medicolegal interpretation
```

That approach is safer and more defensible than assigning manner, weapon, wound age, or range from a single sign.
