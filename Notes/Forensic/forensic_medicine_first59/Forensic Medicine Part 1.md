...
```mermaid
flowchart TD
    A[Mechanical injuries] --> B[Blunt force]
    A --> C[Sharp force]
    B --> B1[Abrasion]
    B --> B2[Contusion]
    B --> B3[Laceration]
    B --> B4[Fractures]
    C --> C1[Incision<br/>Light cutting weapon]
    C --> C2[Chop wound<br/>Heavy cutting weapon]
    C --> C3[Stab wound<br/>Depth: max dimension]
    C3 --> C4[Pointed weapon]
```
...
flowchart TD
    A[Abrasion] --> B{Force}
    B -->|Tangential force| C[Scratch abrasion]
    B -->|Tangential force| D[Grazed abrasion / gravel rash / brush burn / friction burn]
    B -->|Perpendicular force| E[Pressure abrasion]
    B -->|Perpendicular force| F[Imprint / impact abrasion]
    E --> G[Eg : Ligature mark]
    F --> H[Eg : Recoil abrasion, whip mark]
    B --> I[Patterned abrasion]
    I --> J[Pressure or imprint abrasion displays the pattern of the weapon]
```
...
```mermaid
flowchart LR
    A[Wound] --> B[Antemortem wound]
    A --> C[Postmortem wound]
    B --> B1[2 zones]
    B1 --> B2[Positive vital reaction]
    B2 --> B3[Regeneration]
    B2 --> B4[Enzyme levels ↑]
    B1 --> B5[Negative vital reaction]
    B5 --> B6[Necrosis of cells]
    B5 --> B7[Enzyme levels ↓]
    C --> C1[No vital reaction]
    C --> C2[No zone]
```
...
```mermaid
flowchart TD
    A[Types of lacerations] --> B[Split laceration]
    A --> C[Avulsion laceration]
    A --> D[Tear laceration]
    A --> E[Stretch laceration]
    B --> B1[AKA incised looking laceration]
    B --> B2[Skin crushed b/w two hard objects / bony prominences]
    C --> C1[Shearing force / Tangential]
    C1 --> C2[Separation of skin from deeper tissues]
    C2 --> C3[Flaying]
    D --> D1[Caused by semi-sharp objects]
    E --> E1[D/t overstretching of skin]
```
...
```mermaid
flowchart LR
    A[Stab wound] --> B[Parallel to Langer's line]
    A --> C[Perpendicular to Langer's line]
    B --> D[↓ Gaping]
    C --> E[↑ Gaping]
```
...
```mermaid
flowchart TD
    A[Defence cuts] --> B[Active]
    A --> C[Passive]
    B --> B1[Seen at palm, 1st web space]
    C --> C1[Seen at forearm, wrist]
```
...
```mermaid
flowchart TD
    A[First fracture line] --> B[Second fracture line]
    B --> C[Third fracture line]
    D[Puppe's rule] --> E[New fracture line never crosses a previous fracture line]
    E --> F[Allows sequencing of fracture lines due to blows]
```
...
```mermaid
flowchart LR
    A[Pedestrian] --> B[First impact with vehicle]
    B --> C[Primary impact injuries]
    C --> C1[Bumper injuries]
    C1 --> C2[Abrasion]
    C1 --> C3[Contusion]
    C1 --> C4[Laceration]
    C1 --> C5[Bumper fracture<br/>Lower limbs]
    B --> D[Second impact with vehicle]
    D --> E[Secondary impact injuries]
    A --> F[Ground impact]
    F --> G[Tertiary impact / secondary injuries]
    G --> H[Extensive abrasions / lacerations]
```
...
```mermaid
flowchart TD
    A[Beck's triad] --> B[Muffled heart sounds]
    A --> C[↑ JVP]
    A --> D[Hypotension]
    E[Cardiac tamponade] --> A
    F[Management] --> G[Pericardiocentesis]
```
...
```mermaid
flowchart TD
    A[Explosion] --> B[Airblast]
    A --> C[Underwater blast]
    A --> D[Solid blast]
    B --> E[GIT injury]
    C --> F[Fractures]
    D --> F
...
```mermaid
flowchart TD
    A[Choking] --> B[Cylinder bore / Unchoked]
    A --> C[Modified choke]
    A --> D[Improved cylinder]
    A --> E[Full choke]
    B --> B1[Maximum dispersion]
    E --> E1[Least dispersion]
```
...
```mermaid
flowchart LR
    A[Contact shot<br/>Gun in contact with skin] --> B[Close shot<br/>Within range of flame]
    B --> C[Near shot<br/>Outside flame, within smoke]
    C --> D[Intermediate shot<br/>Outside smoke, within gunpowder]
    D --> E[Distant shot<br/>Outside gunpowder range]
    A --> F[Range of flame]
    B --> G[Range of smoke]
    C --> H[Range of gunpowder]
    D --> I[Range of bullet]
```
...
```mermaid
flowchart TD
    A[Offences] --> B[Cognizable]
    A --> C[Non-cognizable]
    A --> D[Warrant case]
    A --> E[Summons case]
    B --> B1[Arrest without warrant]
    C --> C1[Arrest only with warrant]
    D --> D1[Serious offences]
    D1 --> D2[Imprisonment > 2 yrs, life imprisonment or death]
    E --> E1[Non-warrant cases]
```
...
```mermaid
flowchart TD
    A[Recording of evidence] --> B[1. Oath / Solemn affirmation]
    B --> C[2. Chief / Direct examination]
    C --> D[3. Cross examination]
    D --> E[4. Re-direct examination]
```
