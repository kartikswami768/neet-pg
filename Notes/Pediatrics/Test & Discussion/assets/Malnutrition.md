...
| ---------------- | -------------------------------------- | -------------------------------------- |
| Best assessed by | Weight for length<br>                  | Height for Age                         |
| Severity         | < - 2 SD: Moderate<br>< - 3 SD: Severe | < - 2 SD: moderate<br>< - 3 SD: Severe |
...
```mermaid
flowchart TD
    A[Malnutrition] --> B[Body must mobilize protein<br/>to survive]

    B --> C{Source of protein loss}

    C --> D[Visceral Protein]
    C --> E[Somatic Protein]

    D --> D1[Enzymes]
    D --> D2[Neurotransmitter-related proteins]
    D --> D3[Albumin]

    D1 --> D4[Impaired metabolic function]
    D2 --> D5[Lethargy]
    D3 --> D6[Edema]
    ...
    F --> F1[Loss of essential survival proteins]
    F1 --> F2[Worse prognosis]
...
| onset               | > 1 year                                         | < 1 year |
| Appetite            | Poor                                             |          |
| Appearance          | Lethargic<br>Moon Facies                         |          |
| Prognosis           | Poor                                             |          |
| Deficit             | Protein                                          |          |
| Additional Features | Fatty liver<br>Skin/Hair changes (**Flag Sign**) |          |
...
|                                             |                                | Stabilisation<br>0-7 Days | Rehabilitation       |
| ------------------------------------------- | ------------------------------ | ------------------------- | -------------------- |
| RBS < 54 mg/dl                              | **Hypoglycemia**               | 3 Days                    |                      |
| Rectal < 35.5º C<br>Oral < 35º C            | **Hypothermia**                | 3                         |                      |
...
| Cause production of ROS which causes damage | **Iron**                       | No iron<br>               | iron given           |
