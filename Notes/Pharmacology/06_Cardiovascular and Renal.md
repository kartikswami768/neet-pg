...
|---|---:|---|
| 1 | 94 | Carbonic anhydrase inhibitors |
| 2 | 95 | Osmotic diuretic (mannitol); loop diuretics |
| 3 | 96 | Loop/thiazide interaction; thiazide diuretics; adverse effects |
| 4 | 97 | Calcium handling comparison; potassium-sparing diuretics |
| 5 | 98 | Amiloride; edema drug-of-choice table; vasopressin agonists |
| 6 | 99 | Vaptans; nocturnal enuresis; diabetes insipidus |
| 7 | 100 | Drugs causing SIADH/DI; RAAS inhibitors |
| 8 | 101 | CKD nephroprotection; ARB special properties; CCBs |
| 9 | 102 | CCB adverse effects; vasodilators; nitrates/nitroprusside |
| 10 | 103 | Hypertension management; hypertensive crisis |
| 11 | 104 | Contraindications; angina; angina classification; organic nitrates |
| 12 | 105 | Nitrates; tolerance; second-line antianginals |
| 13 | 106 | Trimetazidine; antianginal combinations; ACS; chronic HF introduction |
| 14 | 107 | Chronic HF cardioprotective drugs; natriuretic peptides; inotropes |
| 15 | 108 | Inotropes; digoxin mechanism, uses, toxicity |
| 16 | 109 | Digoxin pharmacokinetics; WPW; HOCM; Vaughan-Williams overview |
| 17 | 110 | Class I antiarrhythmics |
| 18 | 111 | Class II, IV and III antiarrhythmics; amiodarone introduction |
| 19 | 112 | Amiodarone adverse effects; dronedarone; purple syndromes |
| 20 | 113 | Miscellaneous antiarrhythmics; PSVT, VT and torsades management |
...
| PDF statement/theme | Handling in this reconstruction |
|---|---|
| Mannitol as a treatment of lithium toxicity | **Corrected:** mannitol is not standard first-line treatment for lithium poisoning; severe poisoning may require hemodialysis |
| Loop diuretic as generic “DOC for hypertensive crisis” | **Qualified:** loop diuretics are primarily for volume overload; IV loop diuresis may be part of management when congestion is present |
| “Only metolazone is safe” at low GFR | **Corrected:** thiazide-like agents retain clinical utility at reduced GFR; no blanket “only safe thiazide” rule |
| Thiazides/loops contraindicated in diabetes, gout, dyslipidemia | **Corrected:** these are adverse-effect/caution issues, not blanket contraindications |
| ACEI/ARB always first drug in every CKD patient | **Corrected:** use depends on CKD etiology/albuminuria and comorbidities; SGLT2 inhibitors and nonsteroidal MRAs have important roles |
| Losartan has an antiplatelet effect by blocking thromboxane A2 receptors | **Not retained as a verified pharmacologic property** |
| “MAD enzyme” exists only in veins | **Corrected:** ALDH2 is involved in nitrate bioactivation; venodilation predominates at lower nitrate doses |
| 8-hour nitrate-free interval as universal rule | **Qualified:** transdermal nitroglycerin labeling commonly uses a nitrate-free interval of about 10-12 hours |
| “Hypertensive urgency” with routine rapid lowering | **Updated:** contemporary guidelines distinguish severe hypertension without acute target-organ injury from hypertensive emergency and do not recommend reflex rapid IV lowering without acute injury |
| MONAS as complete ACS treatment | **Updated:** retained as historical PDF mnemonic, but current ACS care emphasizes aspirin + P2Y12 inhibition + anticoagulation when indicated + high-intensity statin + reperfusion strategy; oxygen/morphine are selective rather than routine |
| “Four cardioprotective beta blockers” in HFrEF | **Corrected:** the strongest guideline-supported mortality data are for carvedilol, sustained-release metoprolol succinate, and bisoprolol |
| Nesiritide as routine HF therapy | **Qualified:** not a core modern guideline-directed therapy |
| Renal failure as absolute digoxin contraindication | **Corrected:** renal impairment requires lower dosing and monitoring; it is not an absolute contraindication |
| Digoxin target 0.6-2.0 ng/mL as a universal therapeutic range | **Updated:** lower serum concentrations are generally preferred; toxicity rises above about 2 ng/mL and may occur even below that threshold |
| DC shock “absolutely contraindicated” in digoxin-associated VF | **Corrected:** life-threatening unstable ventricular arrhythmias still require appropriate electrical therapy; digoxin-specific Fab is critical when indicated |
| Class IB “opens K+ channels” | **Corrected:** class IB drugs are Na+ channel blockers; they generally shorten or have little effect on ventricular APD |
| Sotalol as exclusively class III | **Qualified:** sotalol has both beta-blocking (class II) and potassium-channel-blocking (class III) actions |
| Vernakalant as a ventricular antiarrhythmic/VF drug | **Corrected:** it is principally an atrial-selective agent used for pharmacological cardioversion of recent AF in jurisdictions where approved |
| Adenosine/atropine listed without modern acute algorithm | **Updated** using current resuscitation guidance |
| Magnesium for all polymorphic VT | **Qualified:** magnesium is most relevant to recurrent torsades associated with prolonged QT; sustained polymorphic VT requires immediate unsynchronized shock |
...
Diuretics are drugs that increase excretion of sodium and/or water in urine.

The PDF organizes the major diuretics by nephron site:
...
- Act at the **proximal convoluted tubule (PCT)**.
...
- PDF teaching point:
  - Useful for increasing urinary excretion of some weak acids.
...
- **B - Bone marrow suppression**
  - Rare but important sulfonamide-related hematologic toxicity.
- **A - Ammonia elevation**
  - The PDF specifically warns about use in liver disease because impaired ammonia handling may aggravate encephalopathy.
- **S - Stones**
  - Calcium phosphate nephrolithiasis.
- **E - Electrolyte/metabolic effects**
  - Hypokalemia
...
- The key clinical use in altitude illness is well established.
- Acetazolamide can worsen metabolic acidosis and may contribute to nephrolithiasis.
- The wording “contraindicated in liver disease” is too absolute for every clinical context; severe hepatic disease with risk of encephalopathy is a major caution because acetazolamide can reduce urinary acid excretion and may alter ammonia handling.
- “Bone marrow suppression” is uncommon, not the typical adverse effect.
...
Do **not** use this as a current lithium-poisoning algorithm.

- Mannitol is not standard first-line treatment for lithium toxicity.
- Initial management generally involves stopping lithium and appropriate fluid/electrolyte management.
- **Hemodialysis** is the definitive extracorporeal therapy for severe lithium poisoning when clinical criteria are met.
...
The PDF labels osmotic diuretics as acting at the loop of Henle. The pharmacology is more accurately described as osmotic diuresis occurring predominantly in the **proximal tubule and thin descending limb**, with effects dependent on the filtered osmole and water permeability.
...
1. Inhibit the **Na+-K+-2Cl- (NKCC2) cotransporter** in the TAL.
...
- Torsemide: longer acting than furosemide.
- Bumetanide: more potent per mg.
...
- Pulmonary edema - PDF calls this **drug of choice**.
- Severe fluid overload.
- Hypertensive crisis - PDF lists this, but the modern qualification is important.
...
**Aspirin + loop diuretic**

- Aspirin is an NSAID.
- NSAIDs inhibit prostaglandin synthesis.
- Reduced renal prostaglandins can reduce renal blood flow and blunt the natriuretic response.

**[Verified correction/update]**

This interaction is pharmacologically plausible and clinically relevant, especially with high-dose NSAIDs and in patients at risk of kidney injury or sodium retention.
...
> “Only thiazide safe in renal failure, when GFR <45” for metolazone.

**[Verified correction/update]**

This wording should **not** be memorized as an absolute rule.

- Thiazide-like agents, especially **metolazone and chlorthalidone**, can retain antihypertensive and/or diuretic effects at reduced GFR.
- The choice depends on the clinical objective, kidney function, volume status, and electrolyte risk.
- There is no contemporary universal statement that metolazone is the “only thiazide safe” below a specific GFR.
...
|---|---|---|
| Effect on Ca2+ | **Lose calcium in urine** | **Retain calcium** |
| Blood Ca2+ | Can lower serum calcium | Can increase serum calcium |
| Classic clinical use | PDF: **DOC for hypercalcemia** | PDF: **DOC for hypercalciuria** |
| Renal stone point | Less useful for prevention of calcium stones | Useful in recurrent calcium stones with hypercalciuria |

**PDF note:**
- The PDF warns about calcium phosphate stone risk with calcium-retaining effects, but the clinical context is more nuanced.
...
- Reduce Na+ reabsorption in the collecting duct.
- Reduce K+ secretion.
...
> Potassium-sparing diuretics are the major diuretic class associated with **hyperkalemia**.

This remains a useful exam pearl.
...
Aldosterone binds its intracellular receptor in principal cells of the collecting duct and promotes:

- ENaC expression/activity
- Na+ reabsorption
- K+ secretion

Therefore, an aldosterone antagonist causes:
...
It is more precise to describe the **mineralocorticoid receptor** as an intracellular receptor rather than saying the drug acts literally “from the basolateral side.” ENaC is the apical/luminal channel that is directly targeted by amiloride/triamterene.
...
- Therefore:
  - **Lower risk of gynecomastia**
  - Sexual adverse effects may be less prominent.

**[PDF]**

The PDF emphasizes lower gynecomastia risk and lower hyperkalemia risk than spironolactone.

**[Verified correction/update]**

The hyperkalemia risk is **not absent** and is still clinically important with eplerenone.
...
Finerenone is a **nonsteroidal mineralocorticoid receptor antagonist** with important evidence in **type 2 diabetes + CKD**, especially in patients with albuminuria, to reduce cardiorenal outcomes when used appropriately. It is not simply another high-volume “diuretic.”

Current CKD guidance places finerenone among important kidney/cardiovascular risk-reducing therapies in appropriately selected patients.
...
The PDF table reconstructs as:

| Type of edema | PDF-listed diuretic of choice |
|---|---|
| Heart failure | Loop diuretic |
| Pulmonary edema | Loop diuretic |
| Renal failure | Loop diuretic |
| Periorbital edema | Loop diuretic |
...
- “Presses” blood vessels.
- Administration: injection.
- Major outcome: vasoconstriction and increased blood pressure.
- PDF indication:
  - Resistant shock, including shock resistant to epinephrine/norepinephrine.

**[Verified correction/update]**

Vasopressin is a vasopressor adjunct in selected forms of vasodilatory shock. Exact use depends on the clinical setting and contemporary ICU/critical-care protocol.
...
Terlipressin is a vasopressin analogue with strong V1a-mediated vasoconstrictor activity and has established use in selected patients with variceal bleeding and **hepatorenal syndrome / HRS-AKI**, depending on jurisdiction and protocol.
...
- Used in SIADH because it reduces renal responsiveness to ADH.

**[Verified correction/update]**

Demeclocycline is no longer a routine first-line SIADH treatment in many modern practices because of nephrotoxicity and availability/preferences for other strategies. It is best remembered as an older pharmacologic option.
...
- Nasal route mentioned for small children.
...
- Its adverse-effect profile and overdose toxicity limit routine use.
...
These may increase endogenous ADH effect/secretion in selected patients, but are not first-line modern replacements for desmopressin.
...
The note says thiazides are contraindicated because of lithium toxicity.

**[Verified correction/update]**

The issue is more nuanced:

- Thiazides can **increase lithium serum concentration** and therefore require substantial caution, lithium dose adjustment, and close monitoring.
- **Amiloride** is particularly useful in lithium-induced nephrogenic DI because it limits lithium entry through ENaC.
- Thiazides are not simply an absolute contraindication in every patient; they are a medication-interaction problem requiring careful management.
...
- **L - Lithium**
- **A - Alcohol** [PDF-listed]
- **P - Phenytoin** [PDF-listed]
- **D - Demeclocycline**

**[Verified correction/update]**

The lithium association is the major high-yield drug-induced nephrogenic DI association.
...
- ACEIs and ARBs are contraindicated in pregnancy because of fetal renal toxicity and related adverse fetal outcomes.
...
- GFR may already depend on angiotensin II-mediated efferent arteriolar constriction.
- RAAS blockade can sharply reduce intraglomerular pressure.
- AKI/oliguria can result.
...
- Stop ACE inhibitor.
- Treat the airway/emergency syndrome appropriately.
- ARB use requires individualized consideration.

**[Verified correction/update]**

Do not list **aliskiren** as the routine automatic replacement for ACEI angioedema.
...
**Reference update:** KDIGO 2024 CKD guidance remains a major current global reference, with a focused 2026 update process for parts of CKD pharmacotherapy.
...
- Lowers uric acid.
- PDF also states an “anti-platelet effect” via thromboxane A2 receptor blockade.
...
- PDF calls it DOC for hypertensive emergency.
...
- PDF says it prevents cerebral vasospasm.
...
> Do not combine verapamil/diltiazem with beta blockers.

**Reason:**

- Excessive AV-nodal suppression
- Bradycardia
- AV block
- Negative inotropy

This is a useful exam and clinical caution, especially with verapamil.
...
Calcium is an important therapy for severe CCB poisoning, but modern toxicology management can also include **high-dose insulin/euglycemia**, vasopressors, and other advanced measures depending on the clinical syndrome. “Calcium gluconate” is therefore better remembered as **one important treatment**, not the sole antidote.
...
|---|---|
| Arterial dilators | Potassium-channel openers, hydralazine |
| Venodilators | Nitrates |
| Mixed arterial + venous | Sodium nitroprusside |
...
- Used in selected heart-failure regimens, especially with isosorbide dinitrate.
- PDF includes it in the **SHIP** mnemonic:
  - Sulfonamides
  - Hydralazine
  - Isoniazid
  - Procainamide
...
Nicorandil also has an **NO-donor** component in addition to KATP-channel activation.
...
- Enzyme-independent in the sense that it does not require the same enzymatic bioactivation pathway as organic nitrates.
...
- Hydroxocobalamin (vitamin B12 form)
- Sodium nitrite
- Amyl nitrite
- Sodium thiosulfate
...
Current sodium nitroprusside labeling emphasizes stopping the drug and use of **sodium nitrite + sodium thiosulfate** in cyanide toxicity. **Hydroxocobalamin** is also used clinically as a cyanide antidote because it binds cyanide to form cyanocobalamin.
...
- **ISMN** has high oral bioavailability.
- ISDN undergoes first-pass metabolism and forms active metabolites, including ISMN.
...
A common transdermal nitroglycerin regimen provides about **10-12 hours nitrate-free each day** to limit tolerance. The exact interval is formulation-dependent.
...
- Contraindication because preload may be critical.
...
- useful for abdominal colicky pain
- not useful for renal colic

**[Unclear / not retained as a routine modern indication]**

This is not a standard modern general indication for organic nitrates and should not be overgeneralized.
...
- ACEI/ARB + CCB
- ACEI/ARB + thiazide-type diuretic
- triple therapy with all three classes when necessary
...
- BP not controlled on 3 drugs in combination.
- DOC:
...
The **2025 AHA/ACC hypertension guideline** defines resistant hypertension as BP above goal despite **3 complementary antihypertensive agents at maximally tolerated doses, one being a diuretic**, or BP controlled only with **4 or more drugs**.

- Spironolactone is a preferred fourth-line option when appropriate.
- Eplerenone is an alternative MRA.
- Aprocitentan, a dual endothelin-receptor antagonist, is a newer option for resistant hypertension.

Important safety issues for MRAs include:
...
| Clinical setting | PDF-preferred class |
|---|---|
...
ACE inhibitors, ARBs, and direct renin inhibition are contraindicated.

Commonly used pregnancy-compatible agents include:

- Labetalol
- Nifedipine
- Methyldopa

Hydralazine is used in selected acute severe-hypertension settings.
...
- Emergency: end-organ damage such as:
  - hemorrhage
  - stroke
  - aortic dissection
...
Contemporary guidance increasingly avoids treating “hypertensive urgency” as a mandate for rapid pharmacologic BP lowering. The critical distinction is:

- **Severe hypertension without acute target-organ injury**
- **Hypertensive emergency with acute target-organ injury**

In hypertensive emergency, IV titratable therapy and controlled reduction are used according to the injured organ.
...
- **N - Nitroprusside**
- **C - Clonidine**
- **A - ACE inhibitor (enalaprilat)**
- **N - Nifedipine / clevidipine**
- **H - Hydralazine**
- **E - Esmolol / labetalol**
- **L - Loop diuretic**
- **P - Phentolamine**
...
- **Nicardipine/clevidipine** are commonly used titratable arterial vasodilators.
- **Nitroprusside** is potent but is not universally preferred because of toxicity and specific clinical considerations.
- **Loop diuretics** are useful when acute pulmonary edema/volume overload is present.
- **Phentolamine** is useful in catecholamine excess.
...
| Situation | PDF teaching point | Verification |
|---|---|---|
| Hyperkalemia / significant renal dysfunction | Avoid or use caution with spironolactone | Correct |
| Pregnancy | Avoid ACEI/ARB | Correct |
| Hyperkalemia | Avoid ACEI | Correct concept |
| Bilateral renal artery stenosis | Avoid/caution with ACEI | Requires individualized interpretation |
| Gout | Avoid thiazides | Better described as caution/possible exacerbation |
| Asthma/COPD | Avoid beta blockers | Strongest for nonselective agents |
| Bradycardia/AV block | Avoid beta blockers, verapamil, diltiazem | Correct major principle |
| Impotence | PDF lists thiazides, beta blockers, CCBs | Adverse effect varies by drug/patient; not a universal class effect |
| ACEI | No impotence risk in PDF | Not a universal guarantee, but sexual adverse effects are not a characteristic class-defining toxicity |
...
Angina is ischemic chest pain due to myocardial oxygen supply-demand mismatch, usually related to coronary artery disease but not necessarily requiring complete coronary occlusion.
...
Current chronic coronary disease guidance supports **beta blocker, CCB, or long-acting nitrate** as antianginal options, with therapy individualized to heart rate, BP, LV function, comorbidities, and tolerance.
...
- Coronary vasodilator.
- PDF says “banned due to coronary steal syndrome.”
...
- Decreases ventricular wall tension and myocardial oxygen demand.

PDF additional benefit:
...
- Metabolic modulator.
- Shifts myocardial energy use from fatty-acid oxidation toward glucose oxidation.
- Glucose oxidation requires less oxygen for ATP production per amount of ATP generated.

**[Verified correction/update]**

The PDF's “P-FOX” wording is best treated as shorthand. Trimetazidine inhibits **3-ketoacyl-CoA thiolase**, thereby reducing long-chain fatty-acid oxidation and favoring glucose oxidation.
...
These are useful exam-time minimum intervals, but exact clinical withholding intervals depend on the particular PDE5 inhibitor, dose, patient factors, and guideline/label.
...
Current ACS guidance emphasizes:

#### Antiplatelet therapy

- Aspirin loading then maintenance.
- Add an oral P2Y12 inhibitor:
  - Ticagrelor
  - Prasugrel
  - Clopidogrel when appropriate

For ACS patients undergoing PCI, ticagrelor or prasugrel are generally preferred over clopidogrel when not contraindicated.

#### Anticoagulation

- Parenteral anticoagulation is indicated in appropriate ACS/revascularization pathways.

#### High-intensity statin

- Atorvastatin 80 mg or rosuvastatin 40 mg are classic high-intensity choices.

#### Oxygen

**Important correction:**

- **Do not give oxygen routinely to every normoxemic MI patient.**
- Oxygen is generally reserved for hypoxemia, respiratory distress, or other appropriate indication.

#### Morphine

- Not routine for every ACS patient.
- Can be reserved for severe refractory ischemic pain.
- Opioids may delay absorption of oral P2Y12 inhibitors.

#### Nitroglycerin

Useful when clinically appropriate, but avoid in major nitrate contraindications such as:

- Suspected right ventricular infarction with preload dependence
- Significant hypotension
- Recent PDE5 inhibitor exposure
...
- Thrombolytics:
  ...
  - Alteplase
  - Tenecteplase
- PDF: thrombolytics for **STEMI**, not NSTEMI.
- PCI:
...
- **Primary PCI** is the preferred reperfusion modality when it can be performed within an appropriate time window.
- If timely PCI cannot be achieved and there are no contraindications, **fibrinolysis** is an appropriate option for eligible STEMI patients, especially when presenting within the early window.
- After fibrinolysis, transfer to a PCI-capable center is generally part of the strategy, with rescue PCI for failed reperfusion.

NSTEMI:

- Fibrinolysis is **not** routine therapy.
- Invasive/revascularization strategy is determined by ischemic risk and clinical status.
...
The three beta blockers with the strongest guideline-supported mortality benefit in HFrEF are:
...
Dapagliflozin and empagliflozin have strong HF evidence and are used in HFrEF irrespective of diabetes status when otherwise appropriate.

SGLT2 inhibitors provide both **cardiorenal** benefit.
...
- Listed for angina and CHF.
- Slows sinus rate through If-current blockade.

**[Verified correction/update]**

In HFrEF, ivabradine is used selectively, typically in patients in **sinus rhythm with elevated resting heart rate despite maximally tolerated evidence-based beta blockade**, according to guideline criteria.
...
- Verapamil and diltiazem contraindicated in CHF due increased mortality.

**[Verified correction/update]**

The key issue is **HFrEF / reduced systolic function** and negative inotropy.

- Verapamil/diltiazem can worsen systolic HF.
- This should not be generalized to every form of “CHF” or every preserved-EF HF phenotype.
...
Nesiritide is **not a core modern guideline-directed chronic HF therapy** and is not routinely used as a standard survival-improving intervention.
...
The core pathophysiologic pearl is correct:

> **Avoid unnecessary positive inotropy in obstructive HCM because increasing contractility can worsen LV outflow obstruction.**

Mavacamten is a cardiac myosin inhibitor used in selected adults with symptomatic obstructive HCM under appropriate specialist oversight.
...
| II | Beta blockers | Metoprolol, esmolol, etc. |
| III | K+ channel blockade / repolarization prolongation | Amiodarone, sotalol, dofetilide, ibutilide |
...
“Class V” is **not a formal universally accepted modern Vaughan-Williams category**. The PDF calls some drugs “Class 5” or “miscellaneous”; in these notes they are best grouped as **miscellaneous/other antiarrhythmic or adjunctive agents**.
...
- Included in SHIP drug mnemonic.
- Drug-induced lupus.
- Sulfonamide-derived amide group.
- Agranulocytosis / bone marrow suppression risk.

**[Verified correction/update]**

Procainamide is indeed associated with:

- Drug-induced lupus
- Agranulocytosis
- QT prolongation / torsades risk

It remains clinically useful in selected arrhythmia settings, including some forms of pre-excited atrial fibrillation and stable wide-complex tachycardia.
...
The PDF does not elaborate further.
...
- **20% IV lipid emulsion** as antidote for local-anesthetic toxicity (e.g., lidocaine/bupivacaine).

This is a major toxicology principle for severe local-anesthetic systemic toxicity.
...
- Increased mortality.
- Contraindicated in MI/structural heart disease.

**[Verified correction/update]**

This remains a major high-yield rule for flecainide/propafenone in patients with prior MI or significant structural heart disease because of proarrhythmic risk.
...
Glucagon is a classic rescue therapy for beta-blocker poisoning, but severe toxicity may require a broader toxicology protocol including high-dose insulin/euglycemia, vasopressors, calcium, lipid emulsion in selected situations, and advanced circulatory support.
...
- Never use in VF/VT because of increased mortality.
- Never combine with beta blockers.

**[Verified correction/update]**

The clinically important rule is:

- Verapamil/diltiazem are **not treatments for ventricular tachycardia** and can be dangerous in some wide-complex rhythms.
- In stable regular narrow-complex tachycardia, they are possible options after appropriate initial therapy.
- In **HFrEF**, non-DHP CCBs are generally avoided because of negative inotropy.
...
The PDF contains visual rhythm/ECG schemas for:

- PSVT
- Ventricular tachycardia
- Torsades de pointes

The visual sequence is more clinically useful when expressed as an emergency algorithm.
...
This reflects contemporary AHA adult advanced-life-support principles. The exact sequence depends on rhythm diagnosis, stability, and contraindications.
...
- High-intensity statin.
- Oxygen is selective, not routine in normoxemia.
...
|---|---|---|---|---|---|
| Carbonic anhydrase inhibitor | PCT | Carbonic anhydrase | Variable / stone risk | K+ loss possible | Bicarbonate loss |
| Osmotic | PCT + thin descending limb (major effect) | Osmotic | Variable | Volume/electrolyte effects | ICP/IOP |
| Loop | TAL | NKCC2 | **Ca2+ loss** | K+ loss | Highest ceiling |
| Thiazide | DCT | NCC | **Ca2+ retention** | K+ loss | HTN, hypercalciuria |
| MRA | Collecting duct | Mineralocorticoid receptor | No major direct effect | **K+ retention** | Spironolactone/eplerenone |
| ENaC blocker | Collecting duct | ENaC | No major direct effect | **K+ retention** | Amiloride |
...
|---|---|---|---|
| Vasopressin | V1 + V2, vasoconstrictor at clinically relevant pressor doses | IV | Vasodilatory shock adjunct |
| Terlipressin | Mainly V1a | IV | Variceal bleeding; HRS-AKI in appropriate settings |
| Desmopressin | V2 selective | Oral/intranasal/other formulations | Central DI, enuresis, hemophilia A/vWD |
| Conivaptan | V1a/V2 antagonist | IV | Selected hospitalized hyponatremia/SIADH |
| Tolvaptan | V2 antagonist | Oral | Selected hyponatremia/SIADH; other specific indications |
| Demeclocycline | Reduces ADH responsiveness | Oral | Older SIADH option |
...
| Feature | DHP | Non-DHP |
|---|---|---|
| Main site | Vascular smooth muscle | Heart + vessels |
| HR | May cause reflex increase | Decrease |
| AV conduction | Little direct effect | Decreased |
| Typical example | Amlodipine | Verapamil |
| Major adverse effect | Edema | Bradycardia/AV block |
| HFrEF | Generally usable with appropriate indication | Avoid due negative inotropy |
...
|---|---|---|
| Typical action | Predominantly venous at lower doses | Balanced arterial + venous |
| NO pathway | Enzymatically bioactivated | Direct NO donor |
| Main use | Angina, selected acute HF/ACS | Hypertensive emergency/selected afterload-preload reduction |
| Tolerance | Yes | Much less characteristic |
| Major toxicity | Headache, hypotension, tolerance | Cyanide/thiocyanate toxicity |
| PDE5 interaction | Major | Not the classic nitrate/PDE5 interaction |
...
| Drug/class | Role |
|---|---|
| Sacubitril/valsartan | Core disease-modifying therapy |
| Carvedilol | Evidence-based beta blocker |
| Metoprolol succinate | Evidence-based beta blocker |
| Bisoprolol | Evidence-based beta blocker |
| Spironolactone/eplerenone | MRA |
| Dapagliflozin/empagliflozin | SGLT2 inhibitor |
| Hydralazine + isosorbide dinitrate | Selected patients |
| Ivabradine | Selected sinus-rhythm patients with elevated HR despite therapy |
| Digoxin | Selected symptom/rate-control role; no mortality benefit |
| Loop diuretic | Symptomatic congestion relief |
...
|---|---|---|
| IA | Na block + K block; ↑ APD/QT | Quinidine, procainamide, disopyramide |
| IB | Na block; little K blockade; ↓/minimal APD | Lidocaine, mexiletine, phenytoin |
| IC | Strong Na block; marked conduction slowing | Flecainide, propafenone |
| II | Beta blockade | Metoprolol, esmolol |
| III | K blockade/repolarization prolongation | Amiodarone, sotalol, dofetilide, ibutilide |
| IV | Ca2+ channel blockade | Verapamil, diltiazem |
| Miscellaneous | Other mechanisms | Adenosine, digoxin, Mg2+, atropine |
...
1. **Ca2+, Na+, K+, Cl- transporter notation**
   - NCC and NKCC2 were restored where OCR had collapsed characters.
2. **“TAL”**
   - Reconstructed as thick ascending limb.
3. **“DCT”**
   - Reconstructed as distal convoluted tubule.
4. **“ENaC”**
   - Reconstructed from the collecting-duct diagram/table.
5. **“AT1 receptor”**
   - Reconstructed from the RAAS schematic.
6. **“If/funny current”**
   - Reconstructed from the ivabradine section.
7. **“ALDH2”**
   - The PDF uses “MAD enzyme” wording. The clinically relevant pathway is represented here more accurately as aldehyde dehydrogenase 2 involvement in nitrate bioactivation.
8. **Amiodarone eye finding**
   - Reconstructed as corneal verticillata / vortex keratopathy.
9. **WPW diagram**
   - Accessory pathway/Bundled Kent wording reconstructed from the figure and text.
10. **Torsades schematic**
    - Interpreted as polymorphic VT associated with prolonged QT.
...
- Mannitol as “treatment of choice” for lithium toxicity.
- Mannitol as a routine treatment for cisplatin toxicity.
- “Only metolazone is safe” below GFR 45 mL/min.
- Thiazides/loops being absolutely contraindicated in diabetes, gout, and dyslipidemia.
- Losartan having a standard antiplatelet effect via thromboxane A2 receptor blockade.
- “MAD enzyme only in veins.”
- Eight-hour nitrate-free interval as a universal formulation-independent rule.
- Prazosin as universal “DOC” for hypertension with BPH.
- “Cheese reaction” as a generic standalone antihypertensive algorithm without clinical context.
- Dipyridamole as globally “banned.”
- Fasudil as a routine standard second-line antianginal.
- MONAS as sufficient modern MI management.
- Oxygen as routine therapy for all MI patients.
- Morphine as routine initial therapy for all MI patients.
- Four beta blockers as equivalent core HFrEF mortality drugs.
- Nesiritide as a current routine core HF therapy.
- Renal failure as an absolute digoxin contraindication.
- Digoxin 0.6-2.0 ng/mL as a universal target.
- Defibrillation as absolutely contraindicated in digoxin-associated VF.
- Class IB drugs as K+ channel openers.
- Sotalol as purely class III.
- Vernakalant as a VF drug.
- Magnesium as routine treatment for every polymorphic VT.
- Atropine as a complete treatment for all bradyarrhythmias.
...
- [x] Osmotic diuretics
- [x] Loop diuretics
- [x] Thiazide/thiazide-like diuretics
- [x] Calcium handling
- [x] Potassium-sparing diuretics
- [x] Edema treatment table
- [x] Vasopressin agonists
- [x] Vaptans
- [x] SIADH
- [x] Nocturnal enuresis
- [x] Diabetes insipidus
- [x] Drug-induced SIADH/DI
- [x] RAAS inhibitors
- [x] CKD nephroprotective drugs
- [x] ARB special properties
- [x] Calcium channel blockers
- [x] Vasodilators
- [x] Nitrates
- [x] Nitroprusside and cyanide toxicity
- [x] Hypertension management
- [x] Resistant hypertension
- [x] Hypertensive crisis
- [x] Angina
- [x] Organic nitrates
- [x] Second-line antianginals
- [x] Antianginal drug interactions
- [x] Acute coronary syndrome / MI
- [x] Reperfusion therapy
- [x] Chronic heart failure
- [x] Cardioprotective HF therapy
- [x] Inotropes
- [x] Digoxin
- [x] Digoxin toxicity/PK
- [x] WPW
- [x] HOCM
- [x] Vaughan-Williams classification
- [x] Class IA
- [x] Class IB
- [x] Class IC
- [x] Class II
- [x] Class III
- [x] Class IV
- [x] Miscellaneous antiarrhythmics
- [x] Amiodarone
- [x] Dronedarone
- [x] Purple syndromes
- [x] PSVT/regular narrow-complex tachycardia
...
- [x] RAAS pathway
- [x] Sodium-channel action-potential relationship
- [x] WPW/accessory-pathway concept
- [x] Amiodarone QT/action-potential schematic
- [x] PSVT rhythm concept
- [x] Ventricular tachycardia/torsades management logic
...
1. **KDIGO 2024 Clinical Practice Guideline for the Evaluation and Management of Chronic Kidney Disease.**  
   Current international CKD reference; KDIGO announced a focused update process in 2026 for selected CKD pharmacotherapy topics.

2. **2025 AHA/ACC/AANP/AAPA/ABC/ACCP/ACPM/AGS/AMA/ASPC/NMA/PCNA Guideline for the Prevention, Detection, Evaluation, and Management of High Blood Pressure in Adults.**  
   Used for resistant hypertension, first-line classes, hypertensive emergencies/severe hypertension, MRAs, aprocitentan, and pregnancy-related contraindications.

3. **2025 ACC/AHA/ACEP/NAEMSP/SCAI Guideline for the Management of Patients With Acute Coronary Syndromes.**  
   Used for contemporary ACS antiplatelet therapy, statins, oxygen/morphine qualification, PCI vs fibrinolysis, and reperfusion strategy.

4. **2022 AHA/ACC/HFSA Guideline for the Management of Heart Failure + 2024 ACC Expert Consensus Decision Pathway for Treatment of HFrEF.**  
   Used for the four foundational HFrEF therapy classes and evidence-based beta blockers.

5. **2023 ACC/AHA/ACCP/HRS Guideline for the Diagnosis and Management of Atrial Fibrillation.**  
   Used for rate-control drugs, HFrEF/CCB cautions, flecainide/propafenone selection, dofetilide/sotalol monitoring, and amiodarone considerations.

6. **2025 AHA Guidelines for Adult Advanced Life Support.**  
   Used for acute management of narrow-complex tachycardia, wide-complex tachycardia, polymorphic VT/torsades, adenosine, cardioversion, and magnesium.

7. **2023 AHA/ACC Guideline for the Management of Patients With Chronic Coronary Disease.**  
   Used for stable angina, vasospastic angina, beta blocker/CCB/nitrate options, and long-term antianginal strategy.

8. **DailyMed - Nitroglycerin products / transdermal nitroglycerin labeling.**  
   Used for nitrate tolerance and nitrate-free interval.

9. **DailyMed - Digoxin prescribing information (current labeling reviewed in 2026).**  
   Used for renal dosing, serum concentration interpretation, toxicity, electrolyte interactions, and pharmacokinetics.

10. **DailyMed - Sodium Nitroprusside prescribing information.**  
    Used for cyanide toxicity and antidotal treatment.
...
For NEET PG/INI-CET-style revision, the highest-yield contrasts in this chapter are:

```text
CA inhibitors vs osmotic vs loop vs thiazide vs K-sparing
             |
             v
Nephron site + transporter + Ca2+/K+ effects
             |
             v
RAAS blockers + CCBs + vasodilators
             |
             v
HTN / angina / ACS
             |
