...
>
> **Purpose:** Reconstructed, topic-organized study document preserving the educational content of the PDF while correcting clear OCR errors and flagging clinically important statements that require qualification or updating.
>
> **Source handling:** Information labelled **PDF** is derived from the attached notes. Statements labelled **Current verification/update** were checked against current authoritative external sources. The PDF remains the primary curriculum source; external sources are used to resolve ambiguity, correct clear inaccuracies, or update time-sensitive treatment recommendations.
...
| Target | Major classes represented in the PDF |
|---|---|
...
**PDF teaching point:** Most cell-wall inhibitors in the notes are described as bactericidal, with **cycloserine** singled out as bacteriostatic. This is an exam-oriented simplification; bactericidal/bacteriostatic behaviour can depend on organism, drug, concentration, and clinical setting.

### Cell-wall inhibitor principles

- β-lactams inhibit **transpeptidation** by binding penicillin-binding proteins (PBPs).
- **Bacitracin** interferes with peptidoglycan precursor transport; the PDF emphasizes topical use against susceptible *Staphylococcus aureus* and lack of activity against MRSA.
...
**PDF:** Penicillin G is described as a natural penicillin derived from *Penicillium*. More precisely, **penicillin G and penicillin V are natural penicillins**; the clinically important distinction is that penicillin G is acid-labile whereas penicillin V is acid-stable enough for oral use.

### Important clinical uses listed in the PDF
...
The PDF notes that **probenecid inhibits renal tubular organic-anion transport**, thereby reducing renal excretion of penicillin and prolonging systemic exposure. This interaction has historically been used to increase penicillin concentrations/duration.

### Pharmacological limitations

The PDF lists the following drawbacks of Penicillin G:
...
- Depot formulation.
- Administered **IM**.
- Slowly absorbed from the injection site.
- Important for **syphilis** and rheumatic fever secondary prophylaxis.

### Procaine penicillin G

- Long-acting injectable preparation.
- The PDF mentions neurotoxicity and cardiotoxicity in relation to prolonged/depot penicillin formulations. Interpret adverse effects in the context of the specific preparation and dose.
...
The precise interval can vary by guideline, age, local epidemiology, and clinical scenario; this note preserves the PDF's stated regimen rather than substituting a universal schedule.
...
The PDF associates these with *E. coli* and other selected Gram-negative organisms while retaining important Gram-positive activity.

### Antipseudomonal penicillins

| Drug group | Drugs | Spectrum emphasized by PDF |
|---|---|---|
...
- The PDF also notes **EBV / infectious mononucleosis** as a setting in which ampicillin should be avoided because of the characteristic maculopapular rash.

---

# 4. Penicillin and β-Lactam Allergy

## 4.1 Hypersensitivity patterns highlighted by the PDF

The notes mention all four classic hypersensitivity categories and specifically illustrate:
...
A reported "penicillin allergy" is not synonymous with a current IgE-mediated allergy. Current CDC guidance notes that many reported penicillin allergies are not confirmed when formally evaluated, and IgE sensitivity can diminish over time. citeturn650547search0
...
This needs qualification rather than the absolute formulation used in the PDF:

- **Third-generation cephalosporins** such as ceftriaxone and cefixime have **low cross-reactivity (<1%)** with IgE-mediated penicillin allergy. citeturn650547search0
- Cross-reactivity with **carbapenems is also low**. The AAAAI practice parameter summarizes a very low risk in patients with confirmed penicillin allergy. citeturn650547search60
- **Aztreonam** generally has minimal cross-reactivity with penicillin/cephalosporin allergy, **except particular concern with ceftazidime allergy** because of a shared side-chain relationship. citeturn650547search60
- Severe delayed reactions such as **SJS/TEN, interstitial nephritis, or hemolytic anemia** are not situations for casual β-lactam rechallenge; specialist assessment is appropriate. citeturn650547search0

### Syphilis and true penicillin allergy

Penicillin remains essential for syphilis in pregnancy, congenital syphilis, and neurosyphilis; desensitization is used when true allergy precludes immediate treatment alternatives. citeturn650547search0
...
CDC recommends a total of **7.2 million units**, administered as **2.4 million units IM at 1-week intervals for 3 doses**, when late latent/tertiary syphilis has a normal CSF evaluation and no indication for neurosyphilis therapy. citeturn860711search5

## 5.3 Neurosyphilis

The PDF correctly identifies **aqueous penicillin G** as the relevant treatment rather than benzathine penicillin.
...
citeturn860711search2

## 5.4 Penicillin allergy in syphilis

The PDF gives doxycycline as an option. This must be stage- and patient-specific.
...
- **Azithromycin should not be used for syphilis** because of documented resistance/treatment failures. citeturn650547search0

### Jarisch–Herxheimer reaction

- Acute febrile inflammatory reaction that may occur after starting treatment for syphilis.
- The PDF labels this under penicillin treatment/hypersensitivity; importantly, **it is not a penicillin allergy**.
...
The PDF describes staphylococcal β-lactamase (penicillinase) as an enzyme that degrades Penicillin G.
...
The PDF describes resistance due to mutation/acquisition affecting the PBP target, specifically **PBP2a**.
...
## 6.3 MRSA treatment examples in the PDF

| Drug | Role / note in PDF |
|---|---|
| Vancomycin | Classic IV treatment for serious MRSA infection |
| Linezolid | Important oral/IV anti-MRSA option; particularly useful in pneumonia |
| Daptomycin | Important bactericidal agent for serious Gram-positive infections; not for pneumonia |
| Tigecycline | Active against MRSA among other organisms; important limitations by syndrome |
...
The PDF gives **"DOC for VRSA: daptomycin > linezolid"**. This should **not** be treated as a universal ranking. Vancomycin-resistant *S. aureus* is rare and management should be guided by the isolate's susceptibility profile and infection site; daptomycin, linezolid and other active agents may be considered depending on the clinical syndrome.

---

# 7. Cephalosporins

## 7.1 Generation-wise framework from the PDF

| Generation | Main examples in PDF | Broad spectrum / major use emphasized in PDF |
|---|---|---|
...
### Naming cues in the PDF

- 1st generation: **cefa/cepha-** examples
- 3rd generation: many drugs end in **-xime / -xone**
- 4th generation: names such as **cefepime / cefpirome** contain the PDF's "-pi-" cue
...
- A disulfiram-like reaction with alcohol is listed in the PDF.
...
Oral carbapenem-like agent listed in the PDF:

- Faropenem

## 9.2 Spectrum and clinical role

The PDF emphasizes carbapenems for severe/hospital-acquired infections and particularly for infections due to many **ESBL-producing Enterobacterales**.
...
The PDF calls **imipenem the most toxic carbapenem** in the seizure/neurotoxicity context; this is a useful exam association but should not be generalized to every possible toxicity metric.
...
The PDF describes combining β-lactams with β-lactamase inhibitors as a strategy to overcome β-lactamase activity.
...
Current IDSA 2026 AMR guidance emphasizes that treatment of ESBL-producing Enterobacterales should be **infection-site and susceptibility specific**. Carbapenems remain important for many invasive ESBL-E infections, while oral TMP-SMX or fluoroquinolones may be appropriate for selected susceptible urinary infections. Newer β-lactam/β-lactamase inhibitor agents are generally preserved for more resistant pathogens rather than being routine replacements for established ESBL therapy. citeturn809649search0turn732532search8
...
This refers conceptually to carbapenemase-producing organisms and the well-known NDM-associated resistance problem identified in the Indian subcontinent.
...
- Colistin/polymyxins are no longer a blanket first-line answer for CRE because toxicity and inferior outcome data limit their role. citeturn809649search0

> **Exam note:** Keep the PDF's historical "carbapenemase → colistin" association in mind as a resistance-class mnemonic, but use current guideline-based therapy clinically.

---

# 11. Monobactam – Aztreonam

- **Aztreonam** is the only clinically important monobactam in the PDF.
...
- Usually has minimal immunologic cross-reactivity with penicillins/other β-lactams, with special caution in **ceftazidime allergy** due to side-chain similarity. citeturn650547search60
...
The diagram on **PDF page 5** illustrates vancomycin binding to the D-Ala-D-Ala terminal peptide of the peptidoglycan precursor.
...
- Useful for **intestinal C. difficile infection** because the drug remains in the gut lumen.
...
Current IDSA/SHEA guidance prefers **fidaxomicin** over a standard course of oral vancomycin for an initial CDI episode when feasible; vancomycin remains an acceptable alternative. For fulminant CDI, oral/NG vancomycin remains central. citeturn860711search0turn860711search95
...
The PDF describes toxic shock syndrome as a toxin-mediated illness associated with **Staphylococcus aureus** and **Streptococcus pyogenes** superantigens.
...
The PDF uses the combination concept:
...
## 15.1 Clinical features listed in the PDF
...
## 15.2 PDF teaching algorithm

```text
Suspected acute bacterial meningitis
          ↓
Empiric antimicrobial therapy + urgent diagnostic evaluation
          ↓
CSF analysis / microbiological testing when safe and feasible
          ↓
Organism-specific therapy when pathogen identified
```

The PDF presents **ceftriaxone injection** as standard empirical therapy and lists:
...
| Suspected organism in PDF | Drug association in PDF | Important current/clinical qualification |
|---|---|---|
...
The PDF identifies high-risk antibiotic associations including:
...
Current CDC information likewise identifies **clindamycin, fluoroquinolones, third-/fourth-generation cephalosporins and carbapenems** among higher-risk antibiotic groups. citeturn650547search1

## 17.2 Treatment agents in the PDF
...
citeturn860711search95

For recurrent CDI, fidaxomicin (standard or extended-pulsed) is preferred over a standard vancomycin course; additional options include vancomycin taper/pulse, bezlotoxumab in selected patients, and microbiota-based approaches/FMT according to current guidance. citeturn860711search0
...
The PDF specifically associates daptomycin with MDR Gram-positive pathogens and states that pulmonary surfactant prevents useful activity in pneumonia.
...
### Intrinsic resistance associations in the PDF
...
Modern CRE management increasingly relies on active β-lactam/β-lactamase inhibitor agents and other targeted drugs rather than polymyxins whenever effective, better-tolerated alternatives are available. citeturn809649search0
...
The PDF labels **secnidazole** as the longest-acting drug in the group.

### Mechanism

Nitroimidazoles are reduced within susceptible organisms to reactive metabolites that damage DNA.

> **OCR correction:** The PDF phrase "forms nitric oxide → DNA damage" is an oversimplification/incorrect rendering. The clinically relevant concept is **reduction of the nitro group to reactive intermediates that produce DNA damage** under anaerobic/protozoal conditions.
...
- **P – pseudomembranous colitis** (historical/selected use of metronidazole; current CDI management prefers fidaxomicin or vancomycin in most adult treatment settings)
...
The PDF teaches avoidance of alcohol because of a presumed disulfiram-like reaction.

**Current qualification:** The evidence for a clinically meaningful disulfiram-like interaction between metronidazole and ethanol is less convincing than traditionally taught. CDC's current BV guidance notes that available evidence does **not** convincingly demonstrate such an interaction. citeturn732532search0

> For exam preparation, remember the traditional "metronidazole + alcohol" warning; for clinical counselling, distinguish historical teaching from the strength of current evidence.

---

# 20. Bacterial Vaginosis vs Trichomoniasis

The PDF includes a visual comparison table.

| Feature | Bacterial vaginosis | Trichomoniasis |
|---|---|---|
| Discharge | Grey-white, typically homogeneous | Yellow-green, often frothy/foul-smelling |
| Vaginal pH | **>4.5** | Often elevated |
...
| Key drug association in PDF | Metronidazole | Metronidazole |

### Current verified treatment examples

**Bacterial vaginosis:** CDC lists **metronidazole 500 mg PO twice daily for 7 days** as a recommended regimen. citeturn732532search0

**Trichomoniasis:** CDC recommends for women **metronidazole 500 mg PO twice daily for 7 days**, while the traditional 2-g single-dose regimen is used in men and as an alternative strategy in selected situations. citeturn732532search3

---

# 21. Fluoroquinolones

## 21.1 Drugs listed in the PDF
...
- Moxifloxacin
- Trovafloxacin
- Sparfloxacin is referenced in the adverse-effect comparison
...
The PDF mnemonic is essentially **HEART–PQRST** plus other toxicities:

- QT interval prolongation
- Dysglycemia / hypoglycemia; the PDF specifically notes **gatifloxacin** as an historical example of problematic dysglycemia and its withdrawal/banning in many markets.
- CNS effects, including seizures in susceptible patients
- Photosensitivity
- Rash
...
The notes associate greater QT risk with **moxifloxacin and sparfloxacin** and least with ciprofloxacin.

### Important clinical safety point

Fluoroquinolone use is increasingly restricted where safer effective alternatives exist because of serious adverse effects and stewardship concerns. FDA labelling for levofloxacin specifically states that for uncomplicated UTI it should be reserved for patients without alternative treatment options. citeturn650547search64

---

# 22. UTI Framework in the PDF
...
The PDF's opening page lists **"fosfomycin 2 g oral single dose"** for UTI.

Current oral fosfomycin tromethamine products are typically supplied as a **single-dose 3 g sachet** for uncomplicated cystitis in adult women. citeturn956856search0turn956856search10
...
- Binds the **23S rRNA of the 50S subunit**.
- Inhibits formation of the initiation complex.

### Streptogramins

- Quinupristin + dalfopristin
- Combined formulation is approximately **30% quinupristin + 70% dalfopristin** in the PDF.
...
The PDF specifically lists **tetracycline as an H. pylori treatment component**. In contemporary regimens, tetracycline is most classically encountered as part of **bismuth quadruple therapy**.

## 25.5 Doxycycline

The PDF correctly emphasizes broad utility, including:
...
The PDF associates ingestion of degraded/expired tetracycline with **Fanconi syndrome**. This is a classic historical pharmacology association with **old tetracycline preparations** and should not be generalized to doxycycline.
...
This remains an important exam rule, but modern practice is more nuanced for **doxycycline**: short courses may be used when benefits outweigh theoretical risks for certain serious infections. The class distinction between doxycycline and older tetracyclines matters, and decisions should be based on indication, duration, age and pregnancy context rather than a simplistic absolute statement for every exposure.
...
- Primarily IV.
- No major renal-dose adjustment advantage is highlighted by the PDF.
...
## 27.2 Uses highlighted by the PDF
...
| Hypertrophic pyloric stenosis association | Yes | Yes | Not the classic association in the PDF |
| Neonatal use in PDF | Caution | Caution | Presented as safer |

### Diphtheria

The PDF gives **erythromycin/azithromycin + antitoxin**.

**Current CDC update:** For respiratory/cutaneous diphtheria, the recommended antibiotics are **erythromycin or penicillin**; **diphtheria antitoxin** is recommended for respiratory disease. citeturn732532search2
...
- If chlamydia has not been excluded, add **doxycycline 100 mg PO twice daily for 7 days**. citeturn860711search3

For uncomplicated chlamydial infection in adults:

- **Doxycycline 100 mg PO twice daily for 7 days** is the recommended regimen.
- Azithromycin 1 g once is an alternative in selected situations. citeturn732532search1
...
- Combination ratio in the PDF: **30% quinupristin + 70% dalfopristin**.
...
- PDF association: **linezolid-resistant staphylococci (LRSA)**.

---

# 30. Aminoglycosides

## 30.1 Drugs in the PDF
...
## 30.3 Clinical associations from the PDF

| Drug / group | PDF association |
|---|---|
...
| Framycetin | Topical preparation; the PDF associates it with the brand **Soframycin** |
...
Oral neomycin (poor GI absorption)
        ↓
Reduced intestinal bacterial load
        ↓
...
> **OCR correction:** The PDF phrase "reversible RTA" should not be used as a defining aminoglycoside toxicity. The canonical toxicity is **proximal tubular injury / nephrotoxicity**, with potential reduction in kidney function.
...
PABA
  ↓
Dihydropteroate / folate synthesis
  ↓
Dihydrofolate
  ↓
...
The PDF associates **spiramycin** with reducing fetal transmission when maternal toxoplasmosis is diagnosed during pregnancy.
...
| Agent | Concentration stated in PDF |
|---|---:|
...
These concentrations are presented as historical/exam pharmacology content. Actual neonatal prophylaxis practice varies by jurisdiction and guideline. In the United States, CDC guidance emphasizes **erythromycin ophthalmic ointment** as the standard prophylactic agent for gonococcal ophthalmia neonatorum; silver nitrate and tetracycline formulations are not the current routine U.S. standard.

---

# 37. Antibiotics in Pregnancy – PDF Table

## Listed as comparatively safe in the PDF

- Penicillins
- Cephalosporins
- Macrolides, especially azithromycin/erythromycin

## Listed as avoid / caution in the PDF
...
## 38.1 PDF "renal-safe" list

The notes identify predominantly biliary-excreted drugs including:
...
The PDF lists intrinsic resistance associations:
...
Additional mechanisms not explicitly tabulated in the PDF but important conceptually include reduced permeability, biofilm formation, target protection and bypass pathways.
...
CDC currently lists **rifampin, ciprofloxacin and ceftriaxone** as effective chemoprophylaxis options for close contacts. Selection should account for local ciprofloxacin resistance; CDC has issued specific guidance for settings where resistant meningococcal strains are prevalent. citeturn732532search4turn732532search9
...
The PDF defines MIC as the lowest concentration that inhibits visible bacterial growth.
...
The PDF associates this with **once-daily dosing** as a typical strategy.
...
The PDF states this often requires multiple doses per day.
...
The PDF provides a teaching table:

| PK/PD category in PDF | Drugs listed |
|---|---|
...
> **Interpretation:** This table is an **exam-oriented simplification from the PDF**, not a universal PK/PD taxonomy. Real antimicrobial PK/PD relationships vary by organism, site, pathogen susceptibility, free-drug exposure, and drug-specific pharmacology.
...
| Amoxicillin/ampicillin | PBP inhibition | Expanded spectrum; **Listeria → ampicillin** | Ampicillin rash in EBV |
| Cloxacillin/oxacillin/nafcillin | Penicillinase-resistant PBP inhibition | MSSA | Hepatic/other class effects; not MRSA |
| Piperacillin–tazobactam | PBP + β-lactamase inhibition | Broad Gram-negative incl. Pseudomonas + anaerobes | Allergy, cytopenias, renal considerations |
| Cefazolin | PBP inhibition | MSSA/streptococci, surgical prophylaxis | Allergy |
| Ceftriaxone | PBP inhibition | Broad Gram-negative; meningitis/gonorrhea etc. depending indication | Biliary effects; neonatal bilirubin concerns |
| Cefepime | PBP inhibition | Broad Gram-negative incl. Pseudomonas | Neurotoxicity if accumulation |
| Ceftaroline | PBP inhibition incl. PBP2a | MRSA | Advanced anti-MRSA cephalosporin |
| Imipenem | PBP inhibition | Very broad; severe resistant infections | Seizures; use with cilastatin |
...
| Tetracyclines | 30S | Block aminoacyl-tRNA at A site | Rickettsia, chlamydia, atypicals; teeth/bone effects |
| Macrolides | 50S | Block translocation | Atypicals, pertussis, diphtheria |
| Clindamycin | 50S | Protein synthesis inhibition | Anaerobes above diaphragm; toxin suppression; high CDI risk |
...
# 45. Classic Exam Pearls From the PDF

1. **Ampicillin → Listeria meningitis.**
2. **Benzathine penicillin G → syphilis.**
3. **Aqueous penicillin G → neurosyphilis.**
4. **MRSA → altered PBP2a.**
5. **Vancomycin → D-Ala-D-Ala.**
6. **Oral vancomycin → luminal C. difficile therapy.**
7. **Daptomycin → not for pneumonia** because pulmonary surfactant inactivates it.
8. **Metronidazole → anaerobes + protozoa; DNA damage after reductive activation.**
9. **Fluoroquinolones → DNA gyrase/topoisomerase IV.**
10. **Tetracyclines → block aminoacyl-tRNA entry into 30S A site.**
11. **Chloramphenicol → peptidyl transferase; aplastic anemia; gray baby syndrome.**
12. **Linezolid → 23S rRNA/50S; thrombocytopenia; serotonin syndrome; neuropathy with prolonged exposure.**
13. **Aminoglycosides → nephrotoxicity + ototoxicity; concentration-dependent killing.**
14. **Trimethoprim → bacterial DHFR.**
15. **Sulfadiazine + pyrimethamine → toxoplasmosis; add folinic acid.**
16. **Cotrimoxazole → SMX:TMP = 5:1.**
17. **Clindamycin → high CDI risk + toxin suppression.**
...
# 46. PDF-Derived Statements Requiring Caution or Updating

| PDF statement | Status | Updated interpretation |
|---|---|---|
...
| Penicillin/cephalosporin/carbapenem cross-allergy treated as broad/absolute | **Needs qualification** | Cross-reactivity is generally low and depends on reaction type and side chain |
| Aztreonam has no cross-allergy | **Needs qualification** | Generally low cross-reactivity, but ceftazidime allergy is a special concern |
| Carbapenemase → colistin as DOC | **Outdated as universal rule** | Use susceptibility-guided modern agents; novel β-lactamase inhibitor combinations often preferred |
| Ceftriaxone alone as universal empiric meningitis therapy | **Oversimplified** | Adult empiric meningitis treatment is usually broader and risk-specific |
| Metronidazole forms nitric oxide causing DNA damage | **OCR/wording error** | Reactive reduced nitroimidazole metabolites cause DNA damage |
| Metronidazole + alcohol causes definite disulfiram reaction | **Traditional teaching; evidence less certain** | Current CDC evidence review does not convincingly establish a clinically meaningful interaction |
| Gonorrhea: ceftriaxone + azithromycin 2 g | **Outdated** | Current CDC regimen uses ceftriaxone 500 mg IM once (<150 kg); add doxycycline if chlamydia not excluded |
| Chlamydia: azithromycin as equal first-line | **Updated** | Doxycycline 100 mg BID × 7 days is current preferred adult regimen; azithromycin is an alternative in selected cases |
| C. difficile: oral vancomycin as default first-line | **Updated** | Fidaxomicin is preferred over standard vancomycin when feasible for initial adult CDI |
| "Aminoglycoside → reversible RTA" | **OCR/medical error** | Canonical toxicity is nephrotoxicity from renal tubular injury, plus ototoxicity and neuromuscular blockade |
| "VRSA → daptomycin > linezolid" | **Oversimplified** | Choice should be susceptibility- and syndrome-guided |
| 1st/2nd/3rd/4th/5th cephalosporin spectra treated as absolute | **Exam simplification** | Individual agents differ; some 3rd/4th generation drugs cover Pseudomonas and advanced agents cover MRSA |

---

# 47. Topic Map of the Entire 15-Page PDF

| PDF pages | Reconstructed topic |
|---|---|
| 1–2 | Classification; cell-wall inhibitors; Penicillin G; penicillin allergy; syphilis; meningococcal prophylaxis; penicillin formulations |
| 3 | MSSA/MRSA resistance; MRSA treatment; Gram-negative resistance; topical mupirocin |
| 4 | ESBL; carbapenemase; cephalosporin generations; spectrum and surgical prophylaxis |
| 5 | Renal/biliary elimination; cephalosporin noncoverage; carbapenems; cilastatin; monobactam; glycopeptides; vancomycin mechanism |
| 6 | Vancomycin uses/adverse effects; red-man reaction; toxic shock syndrome; meningitis framework |
| 7 | Organism-specific therapy; C. difficile; fidaxomicin/bezlotoxumab; cell membrane inhibitors; daptomycin; colistin |
| 8 | Nitroimidazoles; anaerobic activity; bacterial vaginosis vs trichomoniasis; fluoroquinolone introduction |
| 9 | Fluoroquinolone adverse effects; UTI; PK/PD introduction; 30S vs 50S protein-synthesis inhibitors |
| 10 | Chloramphenicol; tetracyclines; doxycycline; adverse effects; newer tetracyclines/tigecycline |
| 11 | Macrolides; CAP/atypicals; CYP effects; diphtheria; STIs; linezolid; streptogramins |
| 12 | Aminoglycosides; oral neomycin; adverse effects; folate inhibitors and pathway |
| 13 | Toxoplasmosis; cotrimoxazole; burns; neonatal conjunctivitis; neonatal avoidance; pregnancy safety |
| 14 | Renal dose adjustment; intrinsic resistance; acquired resistance mechanisms; PK/PD graph |
| 15 | MIC; concentration- vs time-dependent killing; post-antibiotic effect table |
...
- **11_Antimicrobials_Part_1.pdf** — attached 15-page pharmacology note; used as the primary curriculum source.

## External verification sources consulted

1. **CDC – Syphilis STI Treatment Guidelines**: stage-specific treatment and penicillin as preferred therapy.  
   https://www.cdc.gov/std/treatment-guidelines/syphilis.htm

2. **CDC – Neurosyphilis, Ocular Syphilis, and Otosyphilis**: current aqueous/procaine penicillin regimens.  
   https://www.cdc.gov/std/treatment-guidelines/neurosyphilis.htm

3. **CDC – Penicillin Allergy**: β-lactam cross-reactivity and allergy evaluation.  
   https://www.cdc.gov/std/treatment-guidelines/penicillin-allergy.htm

4. **AAAAI – Drug Allergy: 2022 Practice Parameter Update**: carbapenem and aztreonam cross-reactivity.  
   https://www.aaaai.org/

5. **IDSA/SHEA – 2021 Focused Update for C. difficile**: fidaxomicin vs vancomycin, recurrent CDI, bezlotoxumab.  
   https://www.idsociety.org/practice-guideline/clostridioides-difficile-2021-focused-update/

6. **CDC – C. diff Facts for Clinicians (2026)**: high-risk antibiotic classes and stewardship.  
   https://www.cdc.gov/c-diff/hcp/clinical-overview/index.html

7. **IDSA – 2026 AMR Guidance**: current treatment framework for ESBL-E, CRE, DTR *P. aeruginosa*, CRAB, etc.  
   https://www.idsociety.org/practice-guideline/amr-guidance/

8. **CDC – Gonococcal Infections**: current ceftriaxone dosing and chlamydia coverage.  
   https://www.cdc.gov/std/treatment-guidelines/gonorrhea-adults.htm

9. **CDC – Chlamydial Infections**: current doxycycline-based regimen.  
   https://www.cdc.gov/std/treatment-guidelines/chlamydia.htm

10. **CDC – Bacterial Vaginosis**: current metronidazole regimens and evidence regarding alcohol interaction.  
    https://www.cdc.gov/std/treatment-guidelines/bv.htm

11. **CDC – Trichomoniasis**: current multidose metronidazole recommendation for women.  
    https://www.cdc.gov/std/treatment-guidelines/trichomoniasis.htm

12. **CDC – Diphtheria Clinical Guidance**: erythromycin/penicillin and antitoxin.  
    https://www.cdc.gov/diphtheria/hcp/clinical-guidance/index.html

13. **DailyMed – Fosfomycin Tromethamine**: current 3-g single-dose oral sachet labelling.  
    https://dailymed.nlm.nih.gov/dailymed/

14. **FDA-approved levofloxacin labelling**: safety warning and reserve use in uncomplicated UTI when alternatives exist.  
    https://www.accessdata.fda.gov/drugsatfda/

---

# 49. Final Completeness / Accuracy Check

- [x] Entire **15-page PDF** represented in the topic map.
- [x] Non-consecutive content was merged under the same pharmacological topic rather than retained as page-by-page fragments.
- [x] Major tables reconstructed, including cephalosporin generations, BV vs trichomoniasis, macrolide comparison, pregnancy/renal tables, and PK/PD framework.
- [x] Mechanisms, clinical uses, adverse effects, contraindications, interactions, resistance mechanisms and dosing associations retained.
- [x] Major OCR artefacts corrected where the visual page/context made the intended meaning clear.
- [x] Clinically important outdated statements were explicitly flagged rather than silently overwritten.
- [x] Current external verification performed for syphilis, β-lactam allergy, CDI, AMR/CRE, gonorrhea, chlamydia, BV, trichomoniasis, diphtheria, meningococcal prophylaxis, fluoroquinolone safety, and fosfomycin dosing.
- [x] The PDF's exam-oriented simplifications are preserved but explicitly identified where they should not be generalized to patient care.

> **Study-use principle:** For NEET-PG/INI-CET, the PDF's classic associations remain useful. For actual prescribing, use the updated guideline/label information and local antimicrobial-resistance data rather than relying on the historical "DOC" labels in the notes.
